 ...
 */
static int
memb_bandParameterList_v1320_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_bandParameterList_v1320_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_additionalRx_Tx_PerformanceReq_r13_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_bandParameterList_v1320_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_bandParameterList_v1320_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_bandParameterList_v1320_2 = {
	...
	{ 0, &asn_PER_type_bandParameterList_v1320_constr_2, SEQUENCE_OF_constraint },
	asn_MBR_bandParameterList_v1320_2,
	1,	/* Single element */
	&asn_SPC_bandParameterList_v1320_specs_2	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_additionalRx_Tx_PerformanceReq_r13_value2enum_4[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_additionalRx_Tx_PerformanceReq_r13_enum2value_4[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_additionalRx_Tx_PerformanceReq_r13_specs_4 = {
...
static const ber_tlv_tag_t asn_DEF_additionalRx_Tx_PerformanceReq_r13_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_additionalRx_Tx_PerformanceReq_r13_4 = {
	...
	{ 0, &asn_PER_type_additionalRx_Tx_PerformanceReq_r13_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_additionalRx_Tx_PerformanceReq_r13_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_BandCombinationParameters_v1320_1[] = {
	{ ATF_POINTER, 2, offsetof(struct BandCombinationParameters_v1320, bandParameterList_v1320),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_bandParameterList_v1320_2,
		0,
		{ 0, &asn_PER_memb_bandParameterList_v1320_constr_2,  memb_bandParameterList_v1320_constraint_1 },
		0, 0, /* No default value */
		"bandParameterList-v1320"
		},
...
static const int asn_MAP_BandCombinationParameters_v1320_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_BandCombinationParameters_v1320_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_BandCombinationParameters_v1320_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_BandCombinationParameters_v1320_specs_1 = {

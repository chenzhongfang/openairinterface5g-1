...
asn_per_constraints_t asn_PER_type_IMSI_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  6,  21 }	/* (SIZE(6..21)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_IMSI_1[] = {
	{ ATF_POINTER, 0, 0,
...
asn_SET_OF_specifics_t asn_SPC_IMSI_specs_1 = {
	sizeof(struct IMSI),
...
asn_TYPE_descriptor_t asn_DEF_IMSI = {
	...
	sizeof(asn_DEF_IMSI_tags_1)
		/sizeof(asn_DEF_IMSI_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_IMSI_constr_1, SEQUENCE_OF_constraint },
	asn_MBR_IMSI_1,
	1,	/* Single element */

...
static int
memb_numFreqEffective_r14_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_numFreqEffectiveReduced_r14_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_numFreqEffective_r14_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  1,  12 }	/* (1..12) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_numFreqEffectiveReduced_r14_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  1,  12 }	/* (1..12) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_member_t asn_MBR_RRCConnectionReconfigurationComplete_v1430_IEs_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct RRCConnectionReconfigurationComplete_v1430_IEs, numFreqEffective_r14),
		...
		0,
		{ 0, &asn_PER_memb_numFreqEffective_r14_constr_3,  memb_numFreqEffective_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct RRCConnectionReconfigurationComplete_v1430_IEs, numFreqEffectiveReduced_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_numFreqEffectiveReduced_r14_constr_4,  memb_numFreqEffectiveReduced_r14_constraint_1 },
		0, 0, /* No default value */
...
static const int asn_MAP_RRCConnectionReconfigurationComplete_v1430_IEs_oms_1[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_RRCConnectionReconfigurationComplete_v1430_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RRCConnectionReconfigurationComplete_v1430_IEs_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionReconfigurationComplete_v1430_IEs_specs_1 = {

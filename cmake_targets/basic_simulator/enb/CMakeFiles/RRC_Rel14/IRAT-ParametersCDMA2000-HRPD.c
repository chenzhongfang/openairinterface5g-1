 ...
 * so here we adjust the DEF accordingly.
 */
static asn_per_constraints_t asn_PER_type_tx_ConfigHRPD_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_rx_ConfigHRPD_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_tx_ConfigHRPD_3 = {
	...
	{ 0, &asn_PER_type_tx_ConfigHRPD_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_rx_ConfigHRPD_6 = {
	...
	{ 0, &asn_PER_type_rx_ConfigHRPD_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_rx_ConfigHRPD_specs_6	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_IRAT_ParametersCDMA2000_HRPD_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_IRAT_ParametersCDMA2000_HRPD_specs_1 = {

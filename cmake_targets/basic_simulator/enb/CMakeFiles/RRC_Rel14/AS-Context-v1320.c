...
static int
memb_wlanConnectionStatusReport_r13_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_wlanConnectionStatusReport_r13_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_SEMI_CONSTRAINED,	-1, -1,  0,  0 }	/* (SIZE(0..MAX)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_AS_Context_v1320_1[] = {
	{ ATF_POINTER, 1, offsetof(struct AS_Context_v1320, wlanConnectionStatusReport_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_wlanConnectionStatusReport_r13_constr_2,  memb_wlanConnectionStatusReport_r13_constraint_1 },
		0, 0, /* No default value */
		"wlanConnectionStatusReport-r13"
		},
};
static const int asn_MAP_AS_Context_v1320_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_AS_Context_v1320_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_AS_Context_v1320_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* wlanConnectionStatusReport-r13 */
};
asn_SEQUENCE_specifics_t asn_SPC_AS_Context_v1320_specs_1 = {

...
asn_TYPE_descriptor_t asn_DEF_range_3 = {
	...
	{ 0, &asn_PER_type_range_constr_3, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_range_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_PhysCellIdRange_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_PhysCellIdRange_specs_1 = {

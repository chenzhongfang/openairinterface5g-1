...
static asn_TYPE_member_t asn_MBR_cdma_SystemTime_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SystemTimeInfoCDMA2000__cdma_SystemTime, choice.synchronousSystemTime),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_synchronousSystemTime_constr_4,  memb_synchronousSystemTime_constraint_3 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SystemTimeInfoCDMA2000__cdma_SystemTime, choice.asynchronousSystemTime),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_asynchronousSystemTime_constr_5,  memb_asynchronousSystemTime_constraint_3 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_cdma_SystemTime_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_cdma_SystemTime_constr_3, CHOICE_constraint },

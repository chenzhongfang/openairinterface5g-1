...
asn_TYPE_descriptor_t asn_DEF_sl_Bandwidth_r14_2 = {
	...
	{ 0, &asn_PER_type_sl_Bandwidth_r14_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_MasterInformationBlock_SL_V2X_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_SL_V2X_r14, directFrameNumber_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_directFrameNumber_r14_constr_10,  memb_directFrameNumber_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_SL_V2X_r14, directSubframeNumber_r14),
		...
		0,
		{ 0, &asn_PER_memb_directSubframeNumber_r14_constr_11,  memb_directSubframeNumber_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_SL_V2X_r14, reserved_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_reserved_r14_constr_13,  memb_reserved_r14_constraint_1 },
		0, 0, /* No default value */
		"reserved-r14"
		},
};

...
asn_TYPE_descriptor_t asn_DEF_t304_2 = {
	...
	{ 0, &asn_PER_type_t304_constr_2, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_geran_12[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct CellChangeOrder__targetRAT_Type__geran, networkControlOrder),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_networkControlOrder_constr_15,  memb_networkControlOrder_constraint_12 },
		0, 0, /* No default value */
		"networkControlOrder"
		},
...
asn_TYPE_descriptor_t asn_DEF_targetRAT_Type_11 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_targetRAT_Type_constr_11, CHOICE_constraint },

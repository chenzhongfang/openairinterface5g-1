...
asn_per_constraints_t asn_PER_type_NeighCellsCRS_Info_r13_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_NeighCellsCRS_Info_r13_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_NeighCellsCRS_Info_r13_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_NeighCellsCRS_Info_r13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_NeighCellsCRS_Info_r13_constr_1, CHOICE_constraint },

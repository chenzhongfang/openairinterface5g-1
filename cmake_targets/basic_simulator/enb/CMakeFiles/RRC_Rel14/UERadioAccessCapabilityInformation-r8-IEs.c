...
asn_TYPE_member_t asn_MBR_UERadioAccessCapabilityInformation_r8_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UERadioAccessCapabilityInformation_r8_IEs, ue_RadioAccessCapabilityInfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_ue_RadioAccessCapabilityInfo_constr_2,  memb_ue_RadioAccessCapabilityInfo_constraint_1 },
...
asn_SEQUENCE_specifics_t asn_SPC_UERadioAccessCapabilityInformation_r8_IEs_specs_1 = {

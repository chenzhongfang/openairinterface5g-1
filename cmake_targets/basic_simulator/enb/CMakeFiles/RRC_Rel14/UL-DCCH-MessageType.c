...
static asn_TYPE_member_t asn_MBR_c2_20[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_DCCH_MessageType__messageClassExtension__c2, choice.scgFailureInformation_r12),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_DCCH_MessageType__messageClassExtension__c2, choice.sidelinkUEInformation_r12),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_DCCH_MessageType__messageClassExtension__c2, choice.wlanConnectionStatusReport_r13),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_DCCH_MessageType__messageClassExtension__c2, choice.rrcConnectionResumeComplete_r13),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */

...
static int
memb_q_QualMinOffset_r9_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_q_QualMinOffset_r9_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (1..8) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_CellSelectionInfo_v920_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CellSelectionInfo_v920, q_QualMinOffset_r9),
		...
		0,
		{ 0, &asn_PER_memb_q_QualMinOffset_r9_constr_3,  memb_q_QualMinOffset_r9_constraint_1 },
		0, 0, /* No default value */
		"q-QualMinOffset-r9"
		},
};
...
asn_SEQUENCE_specifics_t asn_SPC_CellSelectionInfo_v920_specs_1 = {

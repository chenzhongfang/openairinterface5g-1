...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	{ ATF_POINTER, 1, offsetof(struct UE_EUTRA_CapabilityAddXDD_Mode_v1060__ext1, otdoa_PositioningCapabilities_r10),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_7 = {
	...
	offsetof(struct UE_EUTRA_CapabilityAddXDD_Mode_v1060__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_UE_EUTRA_CapabilityAddXDD_Mode_v1060_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct UE_EUTRA_CapabilityAddXDD_Mode_v1060, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,

...
asn_TYPE_member_t asn_MBR_PUSCH_ConfigDedicatedSCell_v1430_1[] = {
...
static const int asn_MAP_PUSCH_ConfigDedicatedSCell_v1430_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_PUSCH_ConfigDedicatedSCell_v1430_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PUSCH_ConfigDedicatedSCell_v1430_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* enable256QAM-r14 */
};
asn_SEQUENCE_specifics_t asn_SPC_PUSCH_ConfigDedicatedSCell_v1430_specs_1 = {

...
static int
memb_cif_InSchedulingCell_r14_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_cif_InSchedulingCell_r14_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  1,  7 }	/* (1..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_CrossCarrierSchedulingConfigLAA_UL_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CrossCarrierSchedulingConfigLAA_UL_r14, cif_InSchedulingCell_r14),
		...
		0,
		{ 0, &asn_PER_memb_cif_InSchedulingCell_r14_constr_3,  memb_cif_InSchedulingCell_r14_constraint_1 },
		0, 0, /* No default value */
		"cif-InSchedulingCell-r14"
		},
};
static const ber_tlv_tag_t asn_DEF_CrossCarrierSchedulingConfigLAA_UL_r14_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CrossCarrierSchedulingConfigLAA_UL_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* schedulingCellId-r14 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cif-InSchedulingCell-r14 */
};
asn_SEQUENCE_specifics_t asn_SPC_CrossCarrierSchedulingConfigLAA_UL_r14_specs_1 = {

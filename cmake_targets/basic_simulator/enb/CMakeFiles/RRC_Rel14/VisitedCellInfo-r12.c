...
static int
memb_timeSpent_r12_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_visitedCellId_r12_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_timeSpent_r12_constr_7 CC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_pci_arfcn_r12_tags_4[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_pci_arfcn_r12_tag2el_4[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_visitedCellId_r12_tag2el_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_visitedCellId_r12_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_visitedCellId_r12_constr_2, CHOICE_constraint },
	asn_MBR_visitedCellId_r12_2,
	2,	/* Elements count */
	&asn_SPC_visitedCellId_r12_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_VisitedCellInfo_r12_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VisitedCellInfo_r12, timeSpent_r12),
		...
		0,
		{ 0, &asn_PER_memb_timeSpent_r12_constr_7,  memb_timeSpent_r12_constraint_1 },
		0, 0, /* No default value */
		"timeSpent-r12"
		},
};
static const int asn_MAP_VisitedCellInfo_r12_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_VisitedCellInfo_r12_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_VisitedCellInfo_r12_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* visitedCellId-r12 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* timeSpent-r12 */
};
asn_SEQUENCE_specifics_t asn_SPC_VisitedCellInfo_r12_specs_1 = {

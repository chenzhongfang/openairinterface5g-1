...
asn_TYPE_descriptor_t asn_DEF_count_Uplink_3 = {
	...
	{ 0, &asn_PER_type_count_Uplink_constr_3, count_Uplink_3_constraint },
	0, 0,	/* No members */
...
asn_TYPE_descriptor_t asn_DEF_count_Downlink_4 = {
	...
	{ 0, &asn_PER_type_count_Downlink_constr_4, count_Downlink_4_constraint },
	0, 0,	/* No members */
...
asn_TYPE_member_t asn_MBR_DRB_CountInfo_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DRB_CountInfo, count_Uplink),
		...
		0,
		{ 0, &asn_PER_memb_count_Uplink_constr_3,  memb_count_Uplink_constraint_1 },
		0, 0, /* No default value */
		"count-Uplink"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DRB_CountInfo, count_Downlink),
		...
		0,
		{ 0, &asn_PER_memb_count_Downlink_constr_4,  memb_count_Downlink_constraint_1 },
		0, 0, /* No default value */
		"count-Downlink"
		},
};

...
asn_TYPE_member_t asn_MBR_SCG_ConfigPartSCG_r12_1[] = {
	{ ATF_POINTER, 8, offsetof(struct SCG_ConfigPartSCG_r12, radioResourceConfigDedicatedSCG_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct SCG_ConfigPartSCG_r12, sCellToReleaseListSCG_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct SCG_ConfigPartSCG_r12, pSCellToAddMod_r12),
	...
	{ ATF_POINTER, 5, offsetof(struct SCG_ConfigPartSCG_r12, sCellToAddModListSCG_r12),
	...
	{ ATF_POINTER, 4, offsetof(struct SCG_ConfigPartSCG_r12, mobilityControlInfoSCG_r12),
	...
	{ ATF_POINTER, 3, offsetof(struct SCG_ConfigPartSCG_r12, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_8,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SCG_ConfigPartSCG_r12, ext2),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext2_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SCG_ConfigPartSCG_r12, ext3),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext3_13,
		0,
...
static const int asn_MAP_SCG_ConfigPartSCG_r12_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };

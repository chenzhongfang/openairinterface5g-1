...
static asn_per_constraints_t asn_PER_type_rlc_Config_r13_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_logicalChannelConfig_r13_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_TYPE_tag2member_t asn_MAP_rlc_Config_r13_tag2el_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_rlc_Config_r13_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_rlc_Config_r13_constr_2, CHOICE_constraint },
...
static const asn_TYPE_tag2member_t asn_MAP_logicalChannelConfig_r13_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* explicitValue */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* defaultValue */
};
...
asn_TYPE_descriptor_t asn_DEF_logicalChannelConfig_r13_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_logicalChannelConfig_r13_constr_5, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_SRB_ToAddMod_NB_r13_1[] = {
...
static const int asn_MAP_SRB_ToAddMod_NB_r13_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_SRB_ToAddMod_NB_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SRB_ToAddMod_NB_r13_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_SRB_ToAddMod_NB_r13_specs_1 = {

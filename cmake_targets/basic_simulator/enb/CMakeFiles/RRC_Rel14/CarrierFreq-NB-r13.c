 ...
 */
static asn_per_constraints_t asn_PER_type_carrierFreqOffset_r13_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 5,  5,  0,  20 }	/* (0..20) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_carrierFreqOffset_r13_value2enum_3[] = {
	{ 0,	4,	"v-10" },
	{ 1,	3,	"v-9" },
	{ 2,	3,	"v-8" },
	{ 3,	3,	"v-7" },
...
static const unsigned int asn_MAP_carrierFreqOffset_r13_enum2value_3[] = {
	10,	/* v-0dot5(10) */
	9,	/* v-1(9) */
	0,	/* v-10(0) */
	8,	/* v-2(8) */
...
static const asn_INTEGER_specifics_t asn_SPC_carrierFreqOffset_r13_specs_3 = {
...
static const ber_tlv_tag_t asn_DEF_carrierFreqOffset_r13_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_carrierFreqOffset_r13_3 = {
	...
	{ 0, &asn_PER_type_carrierFreqOffset_r13_constr_3, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_carrierFreqOffset_r13_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_CarrierFreq_NB_r13_1[] = {
...
static const int asn_MAP_CarrierFreq_NB_r13_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_CarrierFreq_NB_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CarrierFreq_NB_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* carrierFreq-r13 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* carrierFreqOffset-r13 */
};
asn_SEQUENCE_specifics_t asn_SPC_CarrierFreq_NB_r13_specs_1 = {

 ...
 * so here we adjust the DEF accordingly.
 */
static asn_per_constraints_t asn_PER_type_loggedMeasurementsIdle_r10_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_standaloneGNSS_Location_r10_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_loggedMeasurementsIdle_r10_2 = {
	...
	{ 0, &asn_PER_type_loggedMeasurementsIdle_r10_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_standaloneGNSS_Location_r10_4 = {
	...
	{ 0, &asn_PER_type_standaloneGNSS_Location_r10_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_standaloneGNSS_Location_r10_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_UE_BasedNetwPerfMeasParameters_r10_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_UE_BasedNetwPerfMeasParameters_r10_specs_1 = {

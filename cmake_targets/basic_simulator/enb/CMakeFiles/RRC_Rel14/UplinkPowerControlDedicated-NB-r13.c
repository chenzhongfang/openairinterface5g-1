...
static int
memb_p0_UE_NPUSCH_r13_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_p0_UE_NPUSCH_r13_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4, -8,  7 }	/* (-8..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_UplinkPowerControlDedicated_NB_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlDedicated_NB_r13, p0_UE_NPUSCH_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_p0_UE_NPUSCH_r13_constr_2,  memb_p0_UE_NPUSCH_r13_constraint_1 },
...
asn_SEQUENCE_specifics_t asn_SPC_UplinkPowerControlDedicated_NB_r13_specs_1 = {

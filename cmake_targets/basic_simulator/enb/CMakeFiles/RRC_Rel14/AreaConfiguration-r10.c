...
asn_per_constraints_t asn_PER_type_AreaConfiguration_r10_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_AreaConfiguration_r10_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_AreaConfiguration_r10_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_AreaConfiguration_r10 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_AreaConfiguration_r10_constr_1, CHOICE_constraint },

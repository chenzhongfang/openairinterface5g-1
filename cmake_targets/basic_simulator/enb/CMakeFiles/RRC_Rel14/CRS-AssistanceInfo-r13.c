...
static asn_TYPE_member_t asn_MBR_ext1_10[] = {
	{ ATF_POINTER, 1, offsetof(struct CRS_AssistanceInfo_r13__ext1, mbsfn_SubframeConfigList_v1430),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_10 = {
	sizeof(struct CRS_AssistanceInfo_r13__ext1),
	offsetof(struct CRS_AssistanceInfo_r13__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_CRS_AssistanceInfo_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CRS_AssistanceInfo_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_10,
		0,

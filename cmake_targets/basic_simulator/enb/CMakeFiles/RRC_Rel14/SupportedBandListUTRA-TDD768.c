...
asn_per_constraints_t asn_PER_type_SupportedBandListUTRA_TDD768_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_SupportedBandListUTRA_TDD768_1[] = {
	{ ATF_POINTER, 0, 0,
...
asn_SET_OF_specifics_t asn_SPC_SupportedBandListUTRA_TDD768_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SupportedBandListUTRA_TDD768 = {
	...
	sizeof(asn_DEF_SupportedBandListUTRA_TDD768_tags_1)
		/sizeof(asn_DEF_SupportedBandListUTRA_TDD768_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_SupportedBandListUTRA_TDD768_constr_1, SEQUENCE_OF_constraint },

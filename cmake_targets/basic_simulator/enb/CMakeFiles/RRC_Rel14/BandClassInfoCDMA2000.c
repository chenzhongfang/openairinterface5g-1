...
static int
memb_threshX_High_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_threshX_Low_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_threshX_High_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  63 }	/* (0..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_threshX_Low_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  63 }	/* (0..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_BandClassInfoCDMA2000_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct BandClassInfoCDMA2000, threshX_High),
		...
		0,
		{ 0, &asn_PER_memb_threshX_High_constr_4,  memb_threshX_High_constraint_1 },
		0, 0, /* No default value */
		"threshX-High"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct BandClassInfoCDMA2000, threshX_Low),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_threshX_Low_constr_5,  memb_threshX_Low_constraint_1 },
		0, 0, /* No default value */
		"threshX-Low"
		},
};
...
asn_SEQUENCE_specifics_t asn_SPC_BandClassInfoCDMA2000_specs_1 = {

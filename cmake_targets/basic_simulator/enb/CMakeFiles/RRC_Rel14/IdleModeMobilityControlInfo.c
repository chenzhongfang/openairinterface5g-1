...
asn_TYPE_descriptor_t asn_DEF_t320_8 = {
	...
	{ 0, &asn_PER_type_t320_constr_8, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_IdleModeMobilityControlInfo_1[] = {
	{ ATF_POINTER, 9, offsetof(struct IdleModeMobilityControlInfo, freqPriorityListEUTRA),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 8, offsetof(struct IdleModeMobilityControlInfo, freqPriorityListGERAN),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct IdleModeMobilityControlInfo, freqPriorityListUTRA_FDD),
	...
	{ ATF_POINTER, 6, offsetof(struct IdleModeMobilityControlInfo, freqPriorityListUTRA_TDD),
	...
	{ ATF_POINTER, 5, offsetof(struct IdleModeMobilityControlInfo, bandClassPriorityListHRPD),
	...
	{ ATF_POINTER, 4, offsetof(struct IdleModeMobilityControlInfo, bandClassPriorityList1XRTT),
	...
	{ ATF_POINTER, 3, offsetof(struct IdleModeMobilityControlInfo, t320),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_t320_8,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct IdleModeMobilityControlInfo, ext1),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext1_18,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct IdleModeMobilityControlInfo, ext2),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext2_20,
		0,
...
static const int asn_MAP_IdleModeMobilityControlInfo_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };

...
asn_TYPE_member_t asn_MBR_ConnEstFailReport_r11_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct ConnEstFailReport_r11, measResultListEUTRA_v1130),
	...
	{ ATF_POINTER, 2, offsetof(struct ConnEstFailReport_r11, ext1),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext1_18,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct ConnEstFailReport_r11, ext2),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext2_22,
		0,
...
static const int asn_MAP_ConnEstFailReport_r11_oms_1[] = { 1, 3, 8, 9, 10 };

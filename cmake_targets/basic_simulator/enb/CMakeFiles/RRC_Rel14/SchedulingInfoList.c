...
asn_per_constraints_t asn_PER_type_SchedulingInfoList_constr_1 CC_NOTUSED = {
...
asn_SET_OF_specifics_t asn_SPC_SchedulingInfoList_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SchedulingInfoList = {
	...
	sizeof(asn_DEF_SchedulingInfoList_tags_1)
		/sizeof(asn_DEF_SchedulingInfoList_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_SchedulingInfoList_constr_1, SEQUENCE_OF_constraint },

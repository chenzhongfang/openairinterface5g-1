...
static asn_per_constraints_t asn_PER_memb_prach_ConfigIndex_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  63 }	/* (0..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_zeroCorrelationZoneConfig_constr_4 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_PRACH_ConfigInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_ConfigInfo, prach_ConfigIndex),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_prach_ConfigIndex_constr_2,  memb_prach_ConfigIndex_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_ConfigInfo, zeroCorrelationZoneConfig),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_zeroCorrelationZoneConfig_constr_4,  memb_zeroCorrelationZoneConfig_constraint_1 },
		0, 0, /* No default value */
...
asn_SEQUENCE_specifics_t asn_SPC_PRACH_ConfigInfo_specs_1 = {

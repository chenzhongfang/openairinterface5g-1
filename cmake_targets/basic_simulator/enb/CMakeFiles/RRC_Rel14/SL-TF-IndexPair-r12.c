...
static int
memb_discSF_Index_r12_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_discPRB_Index_r12_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_discSF_Index_r12_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  1,  200 }	/* (1..200) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_discPRB_Index_r12_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  1,  50 }	/* (1..50) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_SL_TF_IndexPair_r12_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SL_TF_IndexPair_r12, discSF_Index_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_discSF_Index_r12_constr_2,  memb_discSF_Index_r12_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct SL_TF_IndexPair_r12, discPRB_Index_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_discPRB_Index_r12_constr_3,  memb_discPRB_Index_r12_constraint_1 },
		0, 0, /* No default value */
		"discPRB-Index-r12"
		},
};
...
asn_SEQUENCE_specifics_t asn_SPC_SL_TF_IndexPair_r12_specs_1 = {

...
asn_TYPE_member_t asn_MBR_SCellToAddModExt_v1430_1[] = {
	{ ATF_POINTER, 1, offsetof(struct SCellToAddModExt_v1430, srs_SwitchFromServCellIndex_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_srs_SwitchFromServCellIndex_r14_constr_2,  memb_srs_SwitchFromServCellIndex_r14_constraint_1 },
		0, 0, /* No default value */
		"srs-SwitchFromServCellIndex-r14"
		},
};
static const int asn_MAP_SCellToAddModExt_v1430_oms_1[] = { 0 };

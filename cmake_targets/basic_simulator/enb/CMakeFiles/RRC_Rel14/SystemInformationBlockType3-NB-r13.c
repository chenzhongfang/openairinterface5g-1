...
static const int asn_MAP_ext3_oms_37[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext3_tags_37[] = {
	(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext3_tag2el_37[] = {
...
static asn_TYPE_member_t asn_MBR_ext4_39[] = {
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType3_NB_r13__ext4, cellReselectionInfoCommon_v1450),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext4_oms_39[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext4_tags_39[] = {
	(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext4_tag2el_39[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* cellReselectionInfoCommon-v1450 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext4_specs_39 = {
	sizeof(struct SystemInformationBlockType3_NB_r13__ext4),
	offsetof(struct SystemInformationBlockType3_NB_r13__ext4, _asn_ctx),
	asn_MAP_ext4_tag2el_39,
	1,	/* Count of tags in the map */
	asn_MAP_ext4_oms_39,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext4_39 = {
	"ext4",
	"ext4",
	&asn_OP_SEQUENCE,
	asn_DEF_ext4_tags_39,
	sizeof(asn_DEF_ext4_tags_39)
		/sizeof(asn_DEF_ext4_tags_39[0]) - 1, /* 1 */
	asn_DEF_ext4_tags_39,	/* Same as above */
	sizeof(asn_DEF_ext4_tags_39)
		/sizeof(asn_DEF_ext4_tags_39[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_ext4_39,
	1,	/* Elements count */
	&asn_SPC_ext4_specs_39	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType3_NB_r13_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct SystemInformationBlockType3_NB_r13, freqBandInfo_r13),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NS_PmaxList_NB_r13,
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct SystemInformationBlockType3_NB_r13, multiBandInfoList_r13),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct SystemInformationBlockType3_NB_r13, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType3_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_33,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType3_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext2_35,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType3_NB_r13, ext3),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext3_37,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType3_NB_r13, ext4),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext4_39,
		0,
...
static const int asn_MAP_SystemInformationBlockType3_NB_r13_oms_1[] = { 3, 4, 5, 6, 7, 8, 9 };

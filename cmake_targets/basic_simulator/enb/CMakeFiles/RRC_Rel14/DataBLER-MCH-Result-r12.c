...
static int
memb_mch_Index_r12_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_mch_Index_r12_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  1,  15 }	/* (1..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_DataBLER_MCH_Result_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DataBLER_MCH_Result_r12, mch_Index_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_mch_Index_r12_constr_2,  memb_mch_Index_r12_constraint_1 },
...
static const ber_tlv_tag_t asn_DEF_DataBLER_MCH_Result_r12_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DataBLER_MCH_Result_r12_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mch-Index-r12 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* dataBLER-Result-r12 */
};
asn_SEQUENCE_specifics_t asn_SPC_DataBLER_MCH_Result_r12_specs_1 = {

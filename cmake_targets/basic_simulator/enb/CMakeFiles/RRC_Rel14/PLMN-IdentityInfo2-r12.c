...
static int
memb_plmn_Index_r12_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_plmn_Index_r12_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  1,  6 }	/* (1..6) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_per_constraints_t asn_PER_type_PLMN_IdentityInfo2_r12_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_PLMN_IdentityInfo2_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PLMN_IdentityInfo2_r12, choice.plmn_Index_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_plmn_Index_r12_constr_2,  memb_plmn_Index_r12_constraint_1 },
...
static const asn_TYPE_tag2member_t asn_MAP_PLMN_IdentityInfo2_r12_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-Index-r12 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* plmnIdentity-r12 */
};
asn_CHOICE_specifics_t asn_SPC_PLMN_IdentityInfo2_r12_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PLMN_IdentityInfo2_r12 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_PLMN_IdentityInfo2_r12_constr_1, CHOICE_constraint },

...
typedef struct SystemInformationBlockType3 {
	...
	struct SystemInformationBlockType3__ext1 {
		struct SystemInformationBlockType3__ext1__s_IntraSearch_v920 {
		...
		struct SystemInformationBlockType3__ext1__s_NonIntraSearch_v920 {
	...
	struct SystemInformationBlockType3__ext2 {
		Q_QualMin_r9_t	*q_QualMinWB_r11;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext2;
	struct SystemInformationBlockType3__ext3 {
		Q_QualMin_r9_t	*q_QualMinRSRQ_OnAllSymbols_r12;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext3;
	struct SystemInformationBlockType3__ext4 {
	...
	struct SystemInformationBlockType3__ext7 {
...
extern asn_TYPE_member_t asn_MBR_SystemInformationBlockType3_1[11];

...
static int
memb_wt_MAC_Address_r14_constraint_5(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_wt_MAC_Address_r14_constr_6 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct LWA_Config_r13__ext1, wt_MAC_Address_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_wt_MAC_Address_r14_constr_6,  memb_wt_MAC_Address_r14_constraint_5 },
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct LWA_Config_r13__ext1),
	offsetof(struct LWA_Config_r13__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LWA_Config_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct LWA_Config_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,

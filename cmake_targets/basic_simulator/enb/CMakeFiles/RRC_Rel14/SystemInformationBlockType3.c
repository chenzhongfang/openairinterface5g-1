...
static const int asn_MAP_ext3_oms_59[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext3_tags_59[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext3_tag2el_59[] = {
...
static const int asn_MAP_ext4_oms_61[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_ext4_tags_61[] = {
	(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext4_tag2el_61[] = {
...
static asn_TYPE_member_t asn_MBR_ext5_66[] = {
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType3__ext5, cellSelectionInfoCE1_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext5_oms_66[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext5_tags_66[] = {
	(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext5_tag2el_66[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* cellSelectionInfoCE1-r13 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext5_specs_66 = {
	sizeof(struct SystemInformationBlockType3__ext5),
	offsetof(struct SystemInformationBlockType3__ext5, _asn_ctx),
	asn_MAP_ext5_tag2el_66,
	1,	/* Count of tags in the map */
	asn_MAP_ext5_oms_66,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext5_66 = {
	"ext5",
	"ext5",
	&asn_OP_SEQUENCE,
	asn_DEF_ext5_tags_66,
	sizeof(asn_DEF_ext5_tags_66)
		/sizeof(asn_DEF_ext5_tags_66[0]) - 1, /* 1 */
	asn_DEF_ext5_tags_66,	/* Same as above */
	sizeof(asn_DEF_ext5_tags_66)
		/sizeof(asn_DEF_ext5_tags_66[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_ext5_66,
	1,	/* Elements count */
	&asn_SPC_ext5_specs_66	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext6_68[] = {
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType3__ext6, cellSelectionInfoCE1_v1360),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext6_oms_68[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext6_tags_68[] = {
	(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext6_tag2el_68[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* cellSelectionInfoCE1-v1360 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext6_specs_68 = {
	sizeof(struct SystemInformationBlockType3__ext6),
	offsetof(struct SystemInformationBlockType3__ext6, _asn_ctx),
	asn_MAP_ext6_tag2el_68,
	1,	/* Count of tags in the map */
	asn_MAP_ext6_oms_68,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext6_68 = {
	"ext6",
	"ext6",
	&asn_OP_SEQUENCE,
	asn_DEF_ext6_tags_68,
	sizeof(asn_DEF_ext6_tags_68)
		/sizeof(asn_DEF_ext6_tags_68[0]) - 1, /* 1 */
	asn_DEF_ext6_tags_68,	/* Same as above */
	sizeof(asn_DEF_ext6_tags_68)
		/sizeof(asn_DEF_ext6_tags_68[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_ext6_68,
	1,	/* Elements count */
	&asn_SPC_ext6_specs_68	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext7_70[] = {
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType3__ext7, cellReselectionInfoCommon_v1460),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext7_oms_70[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext7_tags_70[] = {
	(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext7_tag2el_70[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* cellReselectionInfoCommon-v1460 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext7_specs_70 = {
	sizeof(struct SystemInformationBlockType3__ext7),
	offsetof(struct SystemInformationBlockType3__ext7, _asn_ctx),
	asn_MAP_ext7_tag2el_70,
	1,	/* Count of tags in the map */
	asn_MAP_ext7_oms_70,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext7_70 = {
	"ext7",
	"ext7",
	&asn_OP_SEQUENCE,
	asn_DEF_ext7_tags_70,
	sizeof(asn_DEF_ext7_tags_70)
		/sizeof(asn_DEF_ext7_tags_70[0]) - 1, /* 1 */
	asn_DEF_ext7_tags_70,	/* Same as above */
	sizeof(asn_DEF_ext7_tags_70)
		/sizeof(asn_DEF_ext7_tags_70[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_ext7_70,
	1,	/* Elements count */
	&asn_SPC_ext7_specs_70	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType3_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct SystemInformationBlockType3, lateNonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct SystemInformationBlockType3, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_48,
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct SystemInformationBlockType3, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_57,
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct SystemInformationBlockType3, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_59,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType3, ext4),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext4_61,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType3, ext5),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext5_66,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType3, ext6),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext6_68,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType3, ext7),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext7_70,
		0,
...
static const int asn_MAP_SystemInformationBlockType3_oms_1[] = { 3, 4, 5, 6, 7, 8, 9, 10 };

...
static asn_per_constraints_t asn_PER_memb_q_QualMin_constr_8 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 5,  5, -24,  0 }	/* (-24..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_threshX_Q_r9_11[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqUTRA_FDD__ext1__threshX_Q_r9, threshX_HighQ_r9),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqUTRA_FDD__ext1__threshX_Q_r9, threshX_LowQ_r9),
...
static const ber_tlv_tag_t asn_DEF_threshX_Q_r9_tags_11[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_threshX_Q_r9_tag2el_11[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* threshX-HighQ-r9 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* threshX-LowQ-r9 */
};
static asn_SEQUENCE_specifics_t asn_SPC_threshX_Q_r9_specs_11 = {
	sizeof(struct CarrierFreqUTRA_FDD__ext1__threshX_Q_r9),
	offsetof(struct CarrierFreqUTRA_FDD__ext1__threshX_Q_r9, _asn_ctx),
	asn_MAP_threshX_Q_r9_tag2el_11,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_threshX_Q_r9_11 = {
	"threshX-Q-r9",
	"threshX-Q-r9",
	&asn_OP_SEQUENCE,
	asn_DEF_threshX_Q_r9_tags_11,
	sizeof(asn_DEF_threshX_Q_r9_tags_11)
		/sizeof(asn_DEF_threshX_Q_r9_tags_11[0]) - 1, /* 1 */
	asn_DEF_threshX_Q_r9_tags_11,	/* Same as above */
	sizeof(asn_DEF_threshX_Q_r9_tags_11)
		/sizeof(asn_DEF_threshX_Q_r9_tags_11[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_threshX_Q_r9_11,
	2,	/* Elements count */
	&asn_SPC_threshX_Q_r9_specs_11	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_10[] = {
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqUTRA_FDD__ext1, threshX_Q_r9),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_threshX_Q_r9_11,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"threshX-Q-r9"
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_10 = {
	sizeof(struct CarrierFreqUTRA_FDD__ext1),
	offsetof(struct CarrierFreqUTRA_FDD__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_CarrierFreqUTRA_FDD_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqUTRA_FDD, q_RxLevMin),
		...
		0,
		{ 0, &asn_PER_memb_q_RxLevMin_constr_6,  memb_q_RxLevMin_constraint_1 },
		0, 0, /* No default value */
		"q-RxLevMin"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqUTRA_FDD, p_MaxUTRA),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_p_MaxUTRA_constr_7,  memb_p_MaxUTRA_constraint_1 },
		0, 0, /* No default value */
		"p-MaxUTRA"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqUTRA_FDD, q_QualMin),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_q_QualMin_constr_8,  memb_q_QualMin_constraint_1 },
		0, 0, /* No default value */
		"q-QualMin"
		},
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqUTRA_FDD, ext1),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext1_10,
		0,

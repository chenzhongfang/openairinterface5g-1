...
asn_TYPE_member_t asn_MBR_CSI_IM_ConfigExt_r12_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_IM_ConfigExt_r12, resourceConfig_r12),
		...
		0,
		{ 0, &asn_PER_memb_resourceConfig_r12_constr_3,  memb_resourceConfig_r12_constraint_1 },
		0, 0, /* No default value */
		"resourceConfig-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_IM_ConfigExt_r12, subframeConfig_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_subframeConfig_r12_constr_4,  memb_subframeConfig_r12_constraint_1 },
		0, 0, /* No default value */
		"subframeConfig-r12"
		},
...
static const int asn_MAP_CSI_IM_ConfigExt_r12_oms_1[] = { 3 };

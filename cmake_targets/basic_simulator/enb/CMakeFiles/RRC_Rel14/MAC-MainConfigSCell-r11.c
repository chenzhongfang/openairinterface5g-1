...
asn_TYPE_member_t asn_MBR_MAC_MainConfigSCell_r11_1[] = {
...
static const int asn_MAP_MAC_MainConfigSCell_r11_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_MAC_MainConfigSCell_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MAC_MainConfigSCell_r11_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* stag-Id-r11 */
};
asn_SEQUENCE_specifics_t asn_SPC_MAC_MainConfigSCell_r11_specs_1 = {

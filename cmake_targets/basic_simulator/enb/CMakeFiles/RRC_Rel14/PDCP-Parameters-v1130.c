 ...
 * so here we adjust the DEF accordingly.
 */
static asn_per_constraints_t asn_PER_type_pdcp_SN_Extension_r11_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_supportRohcContextContinue_r11_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_pdcp_SN_Extension_r11_value2enum_2[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_pdcp_SN_Extension_r11_enum2value_2[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_pdcp_SN_Extension_r11_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_pdcp_SN_Extension_r11_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_pdcp_SN_Extension_r11_2 = {
	...
	{ 0, &asn_PER_type_pdcp_SN_Extension_r11_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_pdcp_SN_Extension_r11_specs_2	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_supportRohcContextContinue_r11_value2enum_4[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_supportRohcContextContinue_r11_enum2value_4[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_supportRohcContextContinue_r11_specs_4 = {
...
static const ber_tlv_tag_t asn_DEF_supportRohcContextContinue_r11_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_supportRohcContextContinue_r11_4 = {
	...
	{ 0, &asn_PER_type_supportRohcContextContinue_r11_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_supportRohcContextContinue_r11_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_PDCP_Parameters_v1130_1[] = {
...
static const int asn_MAP_PDCP_Parameters_v1130_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_PDCP_Parameters_v1130_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PDCP_Parameters_v1130_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pdcp-SN-Extension-r11 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* supportRohcContextContinue-r11 */
};
asn_SEQUENCE_specifics_t asn_SPC_PDCP_Parameters_v1130_specs_1 = {

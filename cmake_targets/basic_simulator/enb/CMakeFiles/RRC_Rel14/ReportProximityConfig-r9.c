 ...
 * so here we adjust the DEF accordingly.
 */
static asn_per_constraints_t asn_PER_type_proximityIndicationEUTRA_r9_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_proximityIndicationUTRA_r9_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_proximityIndicationEUTRA_r9_2 = {
	...
	{ 0, &asn_PER_type_proximityIndicationEUTRA_r9_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_proximityIndicationUTRA_r9_4 = {
	...
	{ 0, &asn_PER_type_proximityIndicationUTRA_r9_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_proximityIndicationUTRA_r9_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_ReportProximityConfig_r9_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_ReportProximityConfig_r9_specs_1 = {

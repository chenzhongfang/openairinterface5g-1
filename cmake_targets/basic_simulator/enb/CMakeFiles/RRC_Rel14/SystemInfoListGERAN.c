...
asn_per_constraints_t asn_PER_type_SystemInfoListGERAN_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  10 }	/* (SIZE(1..10)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_SystemInfoListGERAN_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (4 << 2)),
		0,
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_Member_constr_2,  memb_OCTET_STRING_constraint_1 },
...
asn_SET_OF_specifics_t asn_SPC_SystemInfoListGERAN_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SystemInfoListGERAN = {
	...
	sizeof(asn_DEF_SystemInfoListGERAN_tags_1)
		/sizeof(asn_DEF_SystemInfoListGERAN_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_SystemInfoListGERAN_constr_1, SEQUENCE_OF_constraint },

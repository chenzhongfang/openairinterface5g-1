...
static int
memb_startingPRB_format5_r13_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_cdm_index_format5_r13_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_startingPRB_format5_r13_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0,  109 }	/* (0..109) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_cdm_index_format5_r13_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_Format5_resource_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Format5_resource_r13, startingPRB_format5_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_startingPRB_format5_r13_constr_2,  memb_startingPRB_format5_r13_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Format5_resource_r13, cdm_index_format5_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_cdm_index_format5_r13_constr_3,  memb_cdm_index_format5_r13_constraint_1 },
		0, 0, /* No default value */
		"cdm-index-format5-r13"
		},
};
static const ber_tlv_tag_t asn_DEF_Format5_resource_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Format5_resource_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* startingPRB-format5-r13 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cdm-index-format5-r13 */
};
asn_SEQUENCE_specifics_t asn_SPC_Format5_resource_r13_specs_1 = {

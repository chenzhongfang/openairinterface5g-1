...
typedef struct X2AP_ENBConfigurationUpdateFailure {
	X2AP_ProtocolIE_Container_4989P16_t	 protocolIEs;
	/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_X2AP_ENBConfigurationUpdateFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_X2AP_ENBConfigurationUpdateFailure_1[1];

...
asn_TYPE_member_t asn_MBR_X2AP_E_RABs_ToBeReleased_RelReqItem_SCG_Bearer_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct X2AP_E_RABs_ToBeReleased_RelReqItem_SCG_Bearer, uL_GTPtunnelEndpoint),
	...
	{ ATF_POINTER, 2, offsetof(struct X2AP_E_RABs_ToBeReleased_RelReqItem_SCG_Bearer, dL_GTPtunnelEndpoint),
	...
	{ ATF_POINTER, 1, offsetof(struct X2AP_E_RABs_ToBeReleased_RelReqItem_SCG_Bearer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_X2AP_ProtocolExtensionContainer_5040P36,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"

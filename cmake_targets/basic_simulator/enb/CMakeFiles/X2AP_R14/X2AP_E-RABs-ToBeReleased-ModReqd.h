...
#ifndef	_X2AP_E_RABs_ToBeReleased_ModReqd_H_
#define	_X2AP_E_RABs_ToBeReleased_ModReqd_H_
...
/* X2AP_E-RABs-ToBeReleased-ModReqd */
typedef struct X2AP_E_RABs_ToBeReleased_ModReqd {
	A_SEQUENCE_OF(struct X2AP_ProtocolIE_Single_Container) list;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} X2AP_E_RABs_ToBeReleased_ModReqd_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_X2AP_E_RABs_ToBeReleased_ModReqd;

#ifdef __cplusplus
}
#endif

#endif	/* _X2AP_E_RABs_ToBeReleased_ModReqd_H_ */

...
#include "X2AP_ServedCellsToModify-Item.h"

#include "X2AP_Neighbour-Information.h"
#include "X2AP_ProtocolExtensionContainer.h"
asn_TYPE_member_t asn_MBR_X2AP_ServedCellsToModify_Item_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct X2AP_ServedCellsToModify_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_X2AP_ProtocolExtensionContainer_5040P7,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_X2AP_ServedCellsToModify_Item_oms_1[] = { 2, 3 };
static const ber_tlv_tag_t asn_DEF_X2AP_ServedCellsToModify_Item_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_X2AP_ServedCellsToModify_Item_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_X2AP_ServedCellsToModify_Item_specs_1 = {

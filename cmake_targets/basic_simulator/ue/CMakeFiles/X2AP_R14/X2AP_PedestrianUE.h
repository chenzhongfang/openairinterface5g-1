...
#ifndef	_X2AP_PedestrianUE_H_
#define	_X2AP_PedestrianUE_H_
...
/* Dependencies */
typedef enum X2AP_PedestrianUE {
	X2AP_PedestrianUE_authorized	= 0,
	X2AP_PedestrianUE_not_authorized	= 1
	/*
...
/* X2AP_PedestrianUE */
typedef long	 X2AP_PedestrianUE_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_X2AP_PedestrianUE_constr_1;
extern asn_TYPE_descriptor_t asn_DEF_X2AP_PedestrianUE;

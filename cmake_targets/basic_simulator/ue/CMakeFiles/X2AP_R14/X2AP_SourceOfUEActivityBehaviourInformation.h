...
#ifndef	_X2AP_SourceOfUEActivityBehaviourInformation_H_
#define	_X2AP_SourceOfUEActivityBehaviourInformation_H_
...
typedef enum X2AP_SourceOfUEActivityBehaviourInformation {
	X2AP_SourceOfUEActivityBehaviourInformation_subscription_information	= 0,
	X2AP_SourceOfUEActivityBehaviourInformation_statistics	= 1
	/*
	 * Enumeration is extensible
	 */
} e_X2AP_SourceOfUEActivityBehaviourInformation;

/* X2AP_SourceOfUEActivityBehaviourInformation */
typedef long	 X2AP_SourceOfUEActivityBehaviourInformation_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_X2AP_SourceOfUEActivityBehaviourInformation_constr_1;
extern asn_TYPE_descriptor_t asn_DEF_X2AP_SourceOfUEActivityBehaviourInformation;
...
#endif	/* _X2AP_SourceOfUEActivityBehaviourInformation_H_ */

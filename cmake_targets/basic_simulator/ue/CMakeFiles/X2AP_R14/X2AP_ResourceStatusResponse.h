...
typedef struct X2AP_ResourceStatusResponse {
	X2AP_ProtocolIE_Container_4989P18_t	 protocolIEs;
	/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_X2AP_ResourceStatusResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_X2AP_ResourceStatusResponse_1[1];

...
#ifndef	_X2AP_E_RABs_ToBeSetupRetrieve_Item_H_
#define	_X2AP_E_RABs_ToBeSetupRetrieve_Item_H_
...
/* X2AP_E-RABs-ToBeSetupRetrieve-Item */
typedef struct X2AP_E_RABs_ToBeSetupRetrieve_Item {
	X2AP_E_RAB_ID_t	 e_RAB_ID;
	X2AP_E_RAB_Level_QoS_Parameters_t	 e_RAB_Level_QoS_Parameters;
	X2AP_BearerType_t	*bearerType;	/* OPTIONAL */
...
} X2AP_E_RABs_ToBeSetupRetrieve_Item_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_X2AP_E_RABs_ToBeSetupRetrieve_Item;

#ifdef __cplusplus
}
#endif

#endif	/* _X2AP_E_RABs_ToBeSetupRetrieve_Item_H_ */

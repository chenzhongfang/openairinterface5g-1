...
/* Dependencies */
typedef enum X2AP_RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts {
	X2AP_RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts_one	= 0,
	X2AP_RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts_two	= 1,
	X2AP_RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts_four	= 2
	/*
	 * Enumeration is extensible
	 */
} e_X2AP_RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts;
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_X2AP_numberOfCellSpecificAntennaPorts_4;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_X2AP_RelativeNarrowbandTxPower;
extern asn_SEQUENCE_specifics_t asn_SPC_X2AP_RelativeNarrowbandTxPower_specs_1;
extern asn_TYPE_member_t asn_MBR_X2AP_RelativeNarrowbandTxPower_1[6];

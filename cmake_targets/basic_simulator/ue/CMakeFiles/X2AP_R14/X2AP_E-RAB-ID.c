...
int
X2AP_E_RAB_ID_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
asn_per_constraints_t asn_PER_type_X2AP_E_RAB_ID_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  4,  4,  0,  15 }	/* (0..15,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const ber_tlv_tag_t asn_DEF_X2AP_E_RAB_ID_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_X2AP_E_RAB_ID = {
	...
	sizeof(asn_DEF_X2AP_E_RAB_ID_tags_1)
		/sizeof(asn_DEF_X2AP_E_RAB_ID_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_X2AP_E_RAB_ID_constr_1, X2AP_E_RAB_ID_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};

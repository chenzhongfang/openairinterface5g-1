...
typedef enum MeasResultUTRA__measResult__ext2__primaryPLMN_Suitable_r12 {
	MeasResultUTRA__measResult__ext2__primaryPLMN_Suitable_r12_true	= 0
} e_MeasResultUTRA__measResult__ext2__primaryPLMN_Suitable_r12;
...
typedef struct MeasResultUTRA {
	...
	struct MeasResultUTRA__measResult {
		 ...
		 */
		struct MeasResultUTRA__measResult__ext1 {
			struct AdditionalSI_Info_r9	*additionalSI_Info_r9;	/* OPTIONAL */
			
			/* Context for parsing across buffer boundaries */
			asn_struct_ctx_t _asn_ctx;
		} *ext1;
		struct MeasResultUTRA__measResult__ext2 {

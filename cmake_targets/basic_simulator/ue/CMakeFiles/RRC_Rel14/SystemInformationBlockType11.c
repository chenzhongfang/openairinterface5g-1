...
asn_TYPE_descriptor_t asn_DEF_warningMessageSegmentType_4 = {
	...
	{ 0, &asn_PER_type_warningMessageSegmentType_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_warningMessageSegmentType_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_SystemInformationBlockType11_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformationBlockType11, messageIdentifier),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_messageIdentifier_constr_2,  memb_messageIdentifier_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformationBlockType11, serialNumber),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_serialNumber_constr_3,  memb_serialNumber_constraint_1 },
		0, 0, /* No default value */
		"serialNumber"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformationBlockType11, warningMessageSegmentNumber),
		...
		0,
		{ 0, &asn_PER_memb_warningMessageSegmentNumber_constr_7,  memb_warningMessageSegmentNumber_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType11, dataCodingScheme),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_dataCodingScheme_constr_9,  memb_dataCodingScheme_constraint_1 },
		0, 0, /* No default value */
		"dataCodingScheme"
		},

...
static int
memb_sid_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_nid_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static int
memb_registrationPeriod_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static int
memb_registrationZone_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static int
memb_totalZone_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static int
memb_zoneTimer_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_sid_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  15,  15 }	/* (SIZE(15..15)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_nid_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  16,  16 }	/* (SIZE(16..16)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_registrationPeriod_constr_11 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  7,  7 }	/* (SIZE(7..7)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_registrationZone_constr_12 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  12,  12 }	/* (SIZE(12..12)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_totalZone_constr_13 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  3,  3 }	/* (SIZE(3..3)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_zoneTimer_constr_14 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  3,  3 }	/* (SIZE(3..3)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_CSFB_RegistrationParam1XRTT_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSFB_RegistrationParam1XRTT, sid),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_sid_constr_2,  memb_sid_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSFB_RegistrationParam1XRTT, nid),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_nid_constr_3,  memb_nid_constraint_1 },
		0, 0, /* No default value */
		"nid"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSFB_RegistrationParam1XRTT, registrationPeriod),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_registrationPeriod_constr_11,  memb_registrationPeriod_constraint_1 },
		0, 0, /* No default value */
		"registrationPeriod"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSFB_RegistrationParam1XRTT, registrationZone),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_registrationZone_constr_12,  memb_registrationZone_constraint_1 },
		0, 0, /* No default value */
		"registrationZone"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSFB_RegistrationParam1XRTT, totalZone),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_totalZone_constr_13,  memb_totalZone_constraint_1 },
		0, 0, /* No default value */
		"totalZone"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSFB_RegistrationParam1XRTT, zoneTimer),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_zoneTimer_constr_14,  memb_zoneTimer_constraint_1 },
		0, 0, /* No default value */
		"zoneTimer"
		},
};
...
asn_SEQUENCE_specifics_t asn_SPC_CSFB_RegistrationParam1XRTT_specs_1 = {

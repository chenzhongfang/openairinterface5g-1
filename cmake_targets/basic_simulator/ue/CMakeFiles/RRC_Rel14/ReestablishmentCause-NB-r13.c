 ...
 */
asn_per_constraints_t asn_PER_type_ReestablishmentCause_NB_r13_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_ReestablishmentCause_NB_r13_value2enum_1[] = {
	{ 0,	22,	"reconfigurationFailure" },
	{ 1,	12,	"otherFailure" },
	{ 2,	6,	"spare2" },
	{ 3,	6,	"spare1" }
};
static const unsigned int asn_MAP_ReestablishmentCause_NB_r13_enum2value_1[] = {
	1,	/* otherFailure(1) */
	0,	/* reconfigurationFailure(0) */
	3,	/* spare1(3) */
	2	/* spare2(2) */
};
const asn_INTEGER_specifics_t asn_SPC_ReestablishmentCause_NB_r13_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_ReestablishmentCause_NB_r13_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_ReestablishmentCause_NB_r13 = {
	...
	sizeof(asn_DEF_ReestablishmentCause_NB_r13_tags_1)
		/sizeof(asn_DEF_ReestablishmentCause_NB_r13_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_ReestablishmentCause_NB_r13_constr_1, NativeEnumerated_constraint },

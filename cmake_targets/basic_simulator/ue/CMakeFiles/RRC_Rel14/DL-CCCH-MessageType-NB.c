...
asn_per_constraints_t asn_PER_type_DL_CCCH_MessageType_NB_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_DL_CCCH_MessageType_NB_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_DL_CCCH_MessageType_NB_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_DL_CCCH_MessageType_NB = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_DL_CCCH_MessageType_NB_constr_1, CHOICE_constraint },

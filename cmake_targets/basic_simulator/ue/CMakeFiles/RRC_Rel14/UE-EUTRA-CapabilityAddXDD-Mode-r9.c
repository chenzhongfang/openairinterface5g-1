...
static int
memb_featureGroupIndicators_r9_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_featureGroupIndRel9Add_r9_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_featureGroupIndicators_r9_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  32,  32 }	/* (SIZE(32..32)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_featureGroupIndRel9Add_r9_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  32,  32 }	/* (SIZE(32..32)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_UE_EUTRA_CapabilityAddXDD_Mode_r9_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct UE_EUTRA_CapabilityAddXDD_Mode_r9, featureGroupIndicators_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_featureGroupIndicators_r9_constr_3,  memb_featureGroupIndicators_r9_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 5, offsetof(struct UE_EUTRA_CapabilityAddXDD_Mode_r9, featureGroupIndRel9Add_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_featureGroupIndRel9Add_r9_constr_4,  memb_featureGroupIndRel9Add_r9_constraint_1 },
		0, 0, /* No default value */
...
asn_SEQUENCE_specifics_t asn_SPC_UE_EUTRA_CapabilityAddXDD_Mode_r9_specs_1 = {

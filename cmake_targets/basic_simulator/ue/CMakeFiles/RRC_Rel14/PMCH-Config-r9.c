 ...
 */
static int
memb_sf_AllocEnd_r9_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_dataMCS_r9_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_type_mch_SchedulingPeriod_r9_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_sf_AllocEnd_r9_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 11,  11,  0,  1535 }	/* (0..1535) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_dataMCS_r9_constr_3 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_mch_SchedulingPeriod_r9_4 = {
	...
	{ 0, &asn_PER_type_mch_SchedulingPeriod_r9_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_mch_SchedulingPeriod_r9_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_PMCH_Config_r9_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PMCH_Config_r9, sf_AllocEnd_r9),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sf_AllocEnd_r9_constr_2,  memb_sf_AllocEnd_r9_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PMCH_Config_r9, dataMCS_r9),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_dataMCS_r9_constr_3,  memb_dataMCS_r9_constraint_1 },
		0, 0, /* No default value */
		"dataMCS-r9"
		},
...
asn_SEQUENCE_specifics_t asn_SPC_PMCH_Config_r9_specs_1 = {

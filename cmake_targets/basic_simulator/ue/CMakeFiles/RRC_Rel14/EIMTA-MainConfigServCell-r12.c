...
asn_TYPE_descriptor_t asn_DEF_eimta_HARQ_ReferenceConfig_r12_5 = {
	...
	{ 0, &asn_PER_type_eimta_HARQ_ReferenceConfig_r12_constr_5, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_mbsfn_SubframeConfigList_v1250_9 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_mbsfn_SubframeConfigList_v1250_constr_9, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EIMTA_MainConfigServCell_r12__setup, eimta_UL_DL_ConfigIndex_r12),
		...
		0,
		{ 0, &asn_PER_memb_eimta_UL_DL_ConfigIndex_r12_constr_4,  memb_eimta_UL_DL_ConfigIndex_r12_constraint_3 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_EIMTA_MainConfigServCell_r12 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_EIMTA_MainConfigServCell_r12_constr_1, CHOICE_constraint },

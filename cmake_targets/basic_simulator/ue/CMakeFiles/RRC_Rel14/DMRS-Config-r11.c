...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DMRS_Config_r11__setup, scramblingIdentity_r11),
		...
		0,
		{ 0, &asn_PER_memb_scramblingIdentity_r11_constr_4,  memb_scramblingIdentity_r11_constraint_3 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DMRS_Config_r11__setup, scramblingIdentity2_r11),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_scramblingIdentity2_r11_constr_5,  memb_scramblingIdentity2_r11_constraint_3 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_DMRS_Config_r11 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_DMRS_Config_r11_constr_1, CHOICE_constraint },

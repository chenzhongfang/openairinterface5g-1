...
static asn_SEQUENCE_specifics_t asn_SPC_criticalExtensionsFuture_specs_4 = {
	sizeof(struct RRCConnectionResumeRequest_r13__criticalExtensions__criticalExtensionsFuture),
	offsetof(struct RRCConnectionResumeRequest_r13__criticalExtensions__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionResumeRequest_r13__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,

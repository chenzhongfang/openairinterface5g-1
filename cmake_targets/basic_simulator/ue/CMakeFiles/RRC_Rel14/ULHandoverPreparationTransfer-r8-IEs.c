...
static asn_per_constraints_t asn_PER_memb_meid_constr_3 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_ULHandoverPreparationTransfer_r8_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ULHandoverPreparationTransfer_r8_IEs, meid),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_meid_constr_3,  memb_meid_constraint_1 },
		0, 0, /* No default value */
		"meid"
		},
...
asn_SEQUENCE_specifics_t asn_SPC_ULHandoverPreparationTransfer_r8_IEs_specs_1 = {

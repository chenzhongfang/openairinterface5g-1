...
static asn_per_constraints_t asn_PER_type_subframeAllocation_constr_10 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_radioframeAllocationPeriod_2 = {
	...
	{ 0, &asn_PER_type_radioframeAllocationPeriod_constr_2, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_subframeAllocation_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MBSFN_SubframeConfig__subframeAllocation, choice.oneFrame),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_oneFrame_constr_11,  memb_oneFrame_constraint_10 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MBSFN_SubframeConfig__subframeAllocation, choice.fourFrames),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_fourFrames_constr_12,  memb_fourFrames_constraint_10 },
		0, 0, /* No default value */
		"fourFrames"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_subframeAllocation_10 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_subframeAllocation_constr_10, CHOICE_constraint },
	asn_MBR_subframeAllocation_10,
	2,	/* Elements count */
	&asn_SPC_subframeAllocation_specs_10	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_MBSFN_SubframeConfig_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MBSFN_SubframeConfig, radioframeAllocationOffset),
		...
		0,
		{ 0, &asn_PER_memb_radioframeAllocationOffset_constr_9,  memb_radioframeAllocationOffset_constraint_1 },
		0, 0, /* No default value */
...
asn_SEQUENCE_specifics_t asn_SPC_MBSFN_SubframeConfig_specs_1 = {

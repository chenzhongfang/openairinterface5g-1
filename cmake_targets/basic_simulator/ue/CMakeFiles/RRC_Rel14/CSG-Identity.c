...
int
CSG_Identity_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
asn_per_constraints_t asn_PER_type_CSG_Identity_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_CSG_Identity = {
	...
	sizeof(asn_DEF_CSG_Identity_tags_1)
		/sizeof(asn_DEF_CSG_Identity_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_CSG_Identity_constr_1, CSG_Identity_constraint },
	0, 0,	/* No members */

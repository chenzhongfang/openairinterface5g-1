...
static int
memb_pSRS_Offset_v1130_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_pSRS_OffsetAp_v1130_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_pSRS_Offset_v1130_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  16,  31 }	/* (16..31) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_pSRS_OffsetAp_v1130_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  16,  31 }	/* (16..31) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_UplinkPowerControlDedicated_v1130_1[] = {
	{ ATF_POINTER, 3, offsetof(struct UplinkPowerControlDedicated_v1130, pSRS_Offset_v1130),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_pSRS_Offset_v1130_constr_2,  memb_pSRS_Offset_v1130_constraint_1 },
	...
	{ ATF_POINTER, 2, offsetof(struct UplinkPowerControlDedicated_v1130, pSRS_OffsetAp_v1130),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_pSRS_OffsetAp_v1130_constr_3,  memb_pSRS_OffsetAp_v1130_constraint_1 },
		0, 0, /* No default value */
		"pSRS-OffsetAp-v1130"
		},
...
asn_SEQUENCE_specifics_t asn_SPC_UplinkPowerControlDedicated_v1130_specs_1 = {

...
static int
memb_hnb_Name_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_hnb_Name_constr_2 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType9_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType9, hnb_Name),
		...
		0,
		{ 0, &asn_PER_memb_hnb_Name_constr_2,  memb_hnb_Name_constraint_1 },

 ...
 */
static int
memb_threeTone_BaseSequence_r13_constraint_21(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_threeTone_CyclicShift_r13_constraint_21(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_sixTone_BaseSequence_r13_constraint_21(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_sixTone_CyclicShift_r13_constraint_21(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_twelveTone_BaseSequence_r13_constraint_21(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_ack_NACK_NumRepetitions_Msg4_r13_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static asn_per_constraints_t asn_PER_type_ack_NACK_NumRepetitions_Msg4_r13_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  3 }	/* (SIZE(1..3)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_srs_SubframeConfig_r13_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  15 }	/* (0..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_threeTone_BaseSequence_r13_constr_22 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  12 }	/* (0..12) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_threeTone_CyclicShift_r13_constr_23 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_sixTone_BaseSequence_r13_constr_24 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  14 }	/* (0..14) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_sixTone_CyclicShift_r13_constr_25 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_twelveTone_BaseSequence_r13_constr_26 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 5,  5,  0,  30 }	/* (0..30) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_ack_NACK_NumRepetitions_Msg4_r13_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  3 }	/* (SIZE(1..3)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_ack_NACK_NumRepetitions_Msg4_r13_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_ack_NACK_NumRepetitions_Msg4_r13_2 = {
	...
	{ 0, &asn_PER_type_ack_NACK_NumRepetitions_Msg4_r13_constr_2, SEQUENCE_OF_constraint },
	asn_MBR_ack_NACK_NumRepetitions_Msg4_r13_2,
	1,	/* Single element */
	&asn_SPC_ack_NACK_NumRepetitions_Msg4_r13_specs_2	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_srs_SubframeConfig_r13_value2enum_4[] = {
	{ 0,	3,	"sc0" },
	{ 1,	3,	"sc1" },
	{ 2,	3,	"sc2" },
	{ 3,	3,	"sc3" },
...
static const unsigned int asn_MAP_srs_SubframeConfig_r13_enum2value_4[] = {
	0,	/* sc0(0) */
	1,	/* sc1(1) */
	10,	/* sc10(10) */
	11,	/* sc11(11) */
...
static const asn_INTEGER_specifics_t asn_SPC_srs_SubframeConfig_r13_specs_4 = {
...
static const ber_tlv_tag_t asn_DEF_srs_SubframeConfig_r13_tags_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_srs_SubframeConfig_r13_4 = {
	...
	{ 0, &asn_PER_type_srs_SubframeConfig_r13_constr_4, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_dmrs_Config_r13_21[] = {
	{ ATF_POINTER, 1, offsetof(struct NPUSCH_ConfigCommon_NB_r13__dmrs_Config_r13, threeTone_BaseSequence_r13),
		...
		0,
		{ 0, &asn_PER_memb_threeTone_BaseSequence_r13_constr_22,  memb_threeTone_BaseSequence_r13_constraint_21 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NPUSCH_ConfigCommon_NB_r13__dmrs_Config_r13, threeTone_CyclicShift_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_threeTone_CyclicShift_r13_constr_23,  memb_threeTone_CyclicShift_r13_constraint_21 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct NPUSCH_ConfigCommon_NB_r13__dmrs_Config_r13, sixTone_BaseSequence_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sixTone_BaseSequence_r13_constr_24,  memb_sixTone_BaseSequence_r13_constraint_21 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NPUSCH_ConfigCommon_NB_r13__dmrs_Config_r13, sixTone_CyclicShift_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sixTone_CyclicShift_r13_constr_25,  memb_sixTone_CyclicShift_r13_constraint_21 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct NPUSCH_ConfigCommon_NB_r13__dmrs_Config_r13, twelveTone_BaseSequence_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_twelveTone_BaseSequence_r13_constr_26,  memb_twelveTone_BaseSequence_r13_constraint_21 },
		0, 0, /* No default value */
		"twelveTone-BaseSequence-r13"
		},
};
static const int asn_MAP_dmrs_Config_r13_oms_21[] = { 0, 2, 4 };
static const ber_tlv_tag_t asn_DEF_dmrs_Config_r13_tags_21[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_dmrs_Config_r13_tag2el_21[] = {
...
asn_TYPE_member_t asn_MBR_NPUSCH_ConfigCommon_NB_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NPUSCH_ConfigCommon_NB_r13, ack_NACK_NumRepetitions_Msg4_r13),
		...
		0,
		{ 0, &asn_PER_memb_ack_NACK_NumRepetitions_Msg4_r13_constr_2,  memb_ack_NACK_NumRepetitions_Msg4_r13_constraint_1 },
		0, 0, /* No default value */
		"ack-NACK-NumRepetitions-Msg4-r13"
		},
...
static const int asn_MAP_NPUSCH_ConfigCommon_NB_r13_oms_1[] = { 1, 2 };
static const ber_tlv_tag_t asn_DEF_NPUSCH_ConfigCommon_NB_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NPUSCH_ConfigCommon_NB_r13_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_NPUSCH_ConfigCommon_NB_r13_specs_1 = {

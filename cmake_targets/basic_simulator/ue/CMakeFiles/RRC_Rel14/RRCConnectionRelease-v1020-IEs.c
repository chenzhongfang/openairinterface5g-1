...
static int
memb_extendedWaitTime_r10_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_extendedWaitTime_r10_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 11,  11,  1,  1800 }	/* (1..1800) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RRCConnectionRelease_v1020_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct RRCConnectionRelease_v1020_IEs, extendedWaitTime_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_extendedWaitTime_r10_constr_2,  memb_extendedWaitTime_r10_constraint_1 },
...
asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionRelease_v1020_IEs_specs_1 = {

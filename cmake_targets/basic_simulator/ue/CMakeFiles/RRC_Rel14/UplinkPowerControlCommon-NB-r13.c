 ...
 */
static int
memb_p0_NominalNPUSCH_r13_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_deltaPreambleMsg3_r13_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_type_alpha_r13_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_p0_NominalNPUSCH_r13_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8, -126,  24 }	/* (-126..24) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_deltaPreambleMsg3_r13_constr_12 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_alpha_r13_3 = {
	...
	{ 0, &asn_PER_type_alpha_r13_constr_3, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_alpha_r13_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_UplinkPowerControlCommon_NB_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlCommon_NB_r13, p0_NominalNPUSCH_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_p0_NominalNPUSCH_r13_constr_2,  memb_p0_NominalNPUSCH_r13_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlCommon_NB_r13, deltaPreambleMsg3_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_deltaPreambleMsg3_r13_constr_12,  memb_deltaPreambleMsg3_r13_constraint_1 },
		0, 0, /* No default value */
...
asn_SEQUENCE_specifics_t asn_SPC_UplinkPowerControlCommon_NB_r13_specs_1 = {

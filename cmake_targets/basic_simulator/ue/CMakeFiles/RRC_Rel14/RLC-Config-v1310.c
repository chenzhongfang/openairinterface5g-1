...
asn_TYPE_member_t asn_MBR_RLC_Config_v1310_1[] = {
...
static const int asn_MAP_RLC_Config_v1310_oms_1[] = { 2 };
static const ber_tlv_tag_t asn_DEF_RLC_Config_v1310_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RLC_Config_v1310_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_RLC_Config_v1310_specs_1 = {

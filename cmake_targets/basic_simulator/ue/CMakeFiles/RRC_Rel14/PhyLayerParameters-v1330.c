...
asn_TYPE_descriptor_t asn_DEF_cch_InterfMitigation_RefRecTypeA_r13_2 = {
	...
	{ 0, &asn_PER_type_cch_InterfMitigation_RefRecTypeA_r13_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_cch_InterfMitigation_RefRecTypeB_r13_4 = {
	...
	{ 0, &asn_PER_type_cch_InterfMitigation_RefRecTypeB_r13_constr_4, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_PhyLayerParameters_v1330_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct PhyLayerParameters_v1330, cch_InterfMitigation_MaxNumCCs_r13),
		...
		0,
		{ 0, &asn_PER_memb_cch_InterfMitigation_MaxNumCCs_r13_constr_6,  memb_cch_InterfMitigation_MaxNumCCs_r13_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct PhyLayerParameters_v1330, crs_InterfMitigationTM1toTM9_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_crs_InterfMitigationTM1toTM9_r13_constr_7,  memb_crs_InterfMitigationTM1toTM9_r13_constraint_1 },
		0, 0, /* No default value */

...
extern asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionReconfigurationComplete_specs_1;
extern asn_TYPE_member_t asn_MBR_RRCConnectionReconfigurationComplete_1[2];

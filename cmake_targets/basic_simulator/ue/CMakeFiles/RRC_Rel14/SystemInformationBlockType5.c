...
static int
memb_scptm_FreqOffset_r14_constraint_18(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_scptm_FreqOffset_r14_constr_19 CC_NOTUSED = {
...
static const int asn_MAP_ext3_oms_10[] = { 0, 1 };
...
static const int asn_MAP_ext4_oms_13[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_ext4_tags_13[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext4_tag2el_13[] = {
...
static const int asn_MAP_ext5_oms_16[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext5_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext5_tag2el_16[] = {
...
static asn_TYPE_member_t asn_MBR_ext6_18[] = {
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType5__ext6, scptm_FreqOffset_r14),
		...
		0,
		{ 0, &asn_PER_memb_scptm_FreqOffset_r14_constr_19,  memb_scptm_FreqOffset_r14_constraint_18 },
		0, 0, /* No default value */
		"scptm-FreqOffset-r14"
		},
};
static const int asn_MAP_ext6_oms_18[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext6_tags_18[] = {
	(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext6_tag2el_18[] = {
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType5_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct SystemInformationBlockType5, lateNonCriticalExtension),
		...
		0,
		{ 0, &asn_PER_memb_lateNonCriticalExtension_constr_4,  memb_lateNonCriticalExtension_constraint_1 },
		0, 0, /* No default value */
...
static const int asn_MAP_SystemInformationBlockType5_oms_1[] = { 1, 2, 3, 4, 5, 6, 7 };

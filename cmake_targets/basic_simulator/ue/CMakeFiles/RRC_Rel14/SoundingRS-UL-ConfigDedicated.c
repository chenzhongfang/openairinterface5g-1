...
asn_TYPE_descriptor_t asn_DEF_srs_Bandwidth_4 = {
	...
	{ 0, &asn_PER_type_srs_Bandwidth_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_srs_HoppingBandwidth_9 = {
	...
	{ 0, &asn_PER_type_srs_HoppingBandwidth_constr_9, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_cyclicShift_18 = {
	...
	{ 0, &asn_PER_type_cyclicShift_constr_18, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SoundingRS_UL_ConfigDedicated__setup, freqDomainPosition),
		...
		0,
		{ 0, &asn_PER_memb_freqDomainPosition_constr_14,  memb_freqDomainPosition_constraint_3 },
		0, 0, /* No default value */
		"freqDomainPosition"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SoundingRS_UL_ConfigDedicated__setup, srs_ConfigIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_srs_ConfigIndex_constr_16,  memb_srs_ConfigIndex_constraint_3 },
		0, 0, /* No default value */
		"srs-ConfigIndex"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SoundingRS_UL_ConfigDedicated__setup, transmissionComb),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_transmissionComb_constr_17,  memb_transmissionComb_constraint_3 },
		0, 0, /* No default value */
		"transmissionComb"
		},
...
asn_TYPE_descriptor_t asn_DEF_SoundingRS_UL_ConfigDedicated = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_SoundingRS_UL_ConfigDedicated_constr_1, CHOICE_constraint },

...
asn_per_constraints_t asn_PER_type_SL_DiscTxPoolToAddModList_r12_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_SL_DiscTxPoolToAddModList_r12_1[] = {
	{ ATF_POINTER, 0, 0,
...
static const ber_tlv_tag_t asn_DEF_SL_DiscTxPoolToAddModList_r12_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_SET_OF_specifics_t asn_SPC_SL_DiscTxPoolToAddModList_r12_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SL_DiscTxPoolToAddModList_r12 = {
	...
	sizeof(asn_DEF_SL_DiscTxPoolToAddModList_r12_tags_1)
		/sizeof(asn_DEF_SL_DiscTxPoolToAddModList_r12_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_SL_DiscTxPoolToAddModList_r12_constr_1, SEQUENCE_OF_constraint },

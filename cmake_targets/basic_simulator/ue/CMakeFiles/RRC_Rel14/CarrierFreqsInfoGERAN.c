...
static int
memb_ncc_Permitted_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_q_RxLevMin_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_p_MaxGERAN_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_ncc_Permitted_constr_5 CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_p_MaxGERAN_constr_7 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_commonInfo_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqsInfoGERAN__commonInfo, ncc_Permitted),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ncc_Permitted_constr_5,  memb_ncc_Permitted_constraint_3 },
		0, 0, /* No default value */
		"ncc-Permitted"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqsInfoGERAN__commonInfo, q_RxLevMin),
		...
		0,
		{ 0, &asn_PER_memb_q_RxLevMin_constr_6,  memb_q_RxLevMin_constraint_3 },
		0, 0, /* No default value */
		"q-RxLevMin"
		},
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqsInfoGERAN__commonInfo, p_MaxGERAN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_p_MaxGERAN_constr_7,  memb_p_MaxGERAN_constraint_3 },
		0, 0, /* No default value */
		"p-MaxGERAN"
		},
...
asn_TYPE_member_t asn_MBR_CarrierFreqsInfoGERAN_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_CarrierFreqsInfoGERAN_specs_1 = {

...
asn_TYPE_member_t asn_MBR_CellSelectionInfo_NB_v1350_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CellSelectionInfo_NB_v1350, delta_RxLevMin_v1350),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_delta_RxLevMin_v1350_constr_2,  memb_delta_RxLevMin_v1350_constraint_1 },
		0, 0, /* No default value */
		"delta-RxLevMin-v1350"
		},
};
static const ber_tlv_tag_t asn_DEF_CellSelectionInfo_NB_v1350_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CellSelectionInfo_NB_v1350_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* delta-RxLevMin-v1350 */
};
asn_SEQUENCE_specifics_t asn_SPC_CellSelectionInfo_NB_v1350_specs_1 = {

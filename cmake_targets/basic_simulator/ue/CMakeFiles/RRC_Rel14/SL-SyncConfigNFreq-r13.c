...
static asn_per_constraints_t asn_PER_type_gnss_Sync_r14_constr_19 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_gnss_Sync_r14_value2enum_19[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_gnss_Sync_r14_enum2value_19[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_gnss_Sync_r14_specs_19 = {
	asn_MAP_gnss_Sync_r14_value2enum_19,	/* "tag" => N; sorted by tag */
	asn_MAP_gnss_Sync_r14_enum2value_19,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_gnss_Sync_r14_tags_19[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_gnss_Sync_r14_19 = {
	"gnss-Sync-r14",
	"gnss-Sync-r14",
	&asn_OP_NativeEnumerated,
	asn_DEF_gnss_Sync_r14_tags_19,
	sizeof(asn_DEF_gnss_Sync_r14_tags_19)
		/sizeof(asn_DEF_gnss_Sync_r14_tags_19[0]) - 1, /* 1 */
	asn_DEF_gnss_Sync_r14_tags_19,	/* Same as above */
	sizeof(asn_DEF_gnss_Sync_r14_tags_19)
		/sizeof(asn_DEF_gnss_Sync_r14_tags_19[0]), /* 2 */
	{ 0, &asn_PER_type_gnss_Sync_r14_constr_19, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_gnss_Sync_r14_specs_19	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_17[] = {
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfigNFreq_r13__ext1, syncOffsetIndicator_v1430),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfigNFreq_r13__ext1, gnss_Sync_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_gnss_Sync_r14_19,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"gnss-Sync-r14"
...
static const int asn_MAP_ext1_oms_17[] = { 0, 1 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_17 = {
	sizeof(struct SL_SyncConfigNFreq_r13__ext1),
	offsetof(struct SL_SyncConfigNFreq_r13__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_21[] = {
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfigNFreq_r13__ext2, syncOffsetIndicator2_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfigNFreq_r13__ext2, syncOffsetIndicator3_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SL_OffsetIndicatorSync_r14,
		0,
...
static const int asn_MAP_ext2_oms_21[] = { 0, 1 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_21 = {
	sizeof(struct SL_SyncConfigNFreq_r13__ext2),
	offsetof(struct SL_SyncConfigNFreq_r13__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SL_SyncConfigNFreq_r13_1[] = {
	{ ATF_POINTER, 5, offsetof(struct SL_SyncConfigNFreq_r13, asyncParameters_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct SL_SyncConfigNFreq_r13, txParameters_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct SL_SyncConfigNFreq_r13, rxParameters_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfigNFreq_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_17,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfigNFreq_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_21,
		0,
...
static const int asn_MAP_SL_SyncConfigNFreq_r13_oms_1[] = { 0, 1, 2, 3, 4 };

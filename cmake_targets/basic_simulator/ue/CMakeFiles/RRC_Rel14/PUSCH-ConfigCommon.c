 ...
 */
static int
memb_n_SB_constraint_2(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_pusch_HoppingOffset_constraint_2(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_type_hoppingMode_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_n_SB_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (1..4) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_pusch_HoppingOffset_constr_7 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_hoppingMode_4 = {
	...
	{ 0, &asn_PER_type_hoppingMode_constr_4, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_pusch_ConfigBasic_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigCommon__pusch_ConfigBasic, n_SB),
		...
		0,
		{ 0, &asn_PER_memb_n_SB_constr_3,  memb_n_SB_constraint_2 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigCommon__pusch_ConfigBasic, pusch_HoppingOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_pusch_HoppingOffset_constr_7,  memb_pusch_HoppingOffset_constraint_2 },
		0, 0, /* No default value */
		"pusch-HoppingOffset"
		},

...
static int
memb_pdsch_Start_r13_constraint_5(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_cif_InSchedulingCell_r13_constraint_5(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_pdsch_Start_r13_constr_7 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (1..4) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_cif_InSchedulingCell_r13_constr_8 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  1,  7 }	/* (1..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_schedulingCellInfo_r13_constr_2 CC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_own_r13_tags_3[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_own_r13_tag2el_3[] = {
...
static asn_TYPE_member_t asn_MBR_other_r13_5[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CrossCarrierSchedulingConfig_r13__schedulingCellInfo_r13__other_r13, pdsch_Start_r13),
		...
		0,
		{ 0, &asn_PER_memb_pdsch_Start_r13_constr_7,  memb_pdsch_Start_r13_constraint_5 },
		0, 0, /* No default value */
		"pdsch-Start-r13"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CrossCarrierSchedulingConfig_r13__schedulingCellInfo_r13__other_r13, cif_InSchedulingCell_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_cif_InSchedulingCell_r13_constr_8,  memb_cif_InSchedulingCell_r13_constraint_5 },
		0, 0, /* No default value */
		"cif-InSchedulingCell-r13"
		},
};
static const ber_tlv_tag_t asn_DEF_other_r13_tags_5[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_other_r13_tag2el_5[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_schedulingCellInfo_r13_tag2el_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_schedulingCellInfo_r13_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_schedulingCellInfo_r13_constr_2, CHOICE_constraint },
	asn_MBR_schedulingCellInfo_r13_2,
	2,	/* Elements count */
	&asn_SPC_schedulingCellInfo_r13_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_CrossCarrierSchedulingConfig_r13_1[] = {
...
static const ber_tlv_tag_t asn_DEF_CrossCarrierSchedulingConfig_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CrossCarrierSchedulingConfig_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* schedulingCellInfo-r13 */
};
asn_SEQUENCE_specifics_t asn_SPC_CrossCarrierSchedulingConfig_r13_specs_1 = {

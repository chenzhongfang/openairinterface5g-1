...
static int
memb_srs_TPC_RNTI_r14_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_startingBitOfFormat3B_r14_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_fieldTypeFormat3B_r14_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_srs_CC_SetIndexlist_r14_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static asn_per_constraints_t asn_PER_type_srs_CC_SetIndexlist_r14_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_srs_TPC_RNTI_r14_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  16,  16 }	/* (SIZE(16..16)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_startingBitOfFormat3B_r14_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 5,  5,  0,  31 }	/* (0..31) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_fieldTypeFormat3B_r14_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (1..4) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_srs_CC_SetIndexlist_r14_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
asn_per_constraints_t asn_PER_type_SRS_TPC_PDCCH_Config_r14_constr_1 CC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_srs_CC_SetIndexlist_r14_tags_7[] = {
...
asn_TYPE_descriptor_t asn_DEF_srs_CC_SetIndexlist_r14_7 = {
	...
	{ 0, &asn_PER_type_srs_CC_SetIndexlist_r14_constr_7, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_TPC_PDCCH_Config_r14__setup, srs_TPC_RNTI_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_srs_TPC_RNTI_r14_constr_4,  memb_srs_TPC_RNTI_r14_constraint_3 },
		0, 0, /* No default value */
		"srs-TPC-RNTI-r14"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_TPC_PDCCH_Config_r14__setup, startingBitOfFormat3B_r14),
		...
		0,
		{ 0, &asn_PER_memb_startingBitOfFormat3B_r14_constr_5,  memb_startingBitOfFormat3B_r14_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_TPC_PDCCH_Config_r14__setup, fieldTypeFormat3B_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_fieldTypeFormat3B_r14_constr_6,  memb_fieldTypeFormat3B_r14_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct SRS_TPC_PDCCH_Config_r14__setup, srs_CC_SetIndexlist_r14),
		...
		0,
		{ 0, &asn_PER_memb_srs_CC_SetIndexlist_r14_constr_7,  memb_srs_CC_SetIndexlist_r14_constraint_3 },
		0, 0, /* No default value */
		"srs-CC-SetIndexlist-r14"
		},
};
...
asn_TYPE_member_t asn_MBR_SRS_TPC_PDCCH_Config_r14_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_SRS_TPC_PDCCH_Config_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
asn_CHOICE_specifics_t asn_SPC_SRS_TPC_PDCCH_Config_r14_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SRS_TPC_PDCCH_Config_r14 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_SRS_TPC_PDCCH_Config_r14_constr_1, CHOICE_constraint },

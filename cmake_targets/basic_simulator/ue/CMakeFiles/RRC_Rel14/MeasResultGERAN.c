...
static int
memb_routingAreaCode_constraint_4(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_rssi_constraint_7(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_routingAreaCode_constr_6 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  8,  8 }	/* (SIZE(8..8)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_rssi_constr_8 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_cgi_Info_4[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResultGERAN__cgi_Info, routingAreaCode),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_routingAreaCode_constr_6,  memb_routingAreaCode_constraint_4 },
		0, 0, /* No default value */
		"routingAreaCode"
		},
};
...
static asn_TYPE_member_t asn_MBR_measResult_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultGERAN__measResult, rssi),
		...
		0,
		{ 0, &asn_PER_memb_rssi_constr_8,  memb_rssi_constraint_7 },
		0, 0, /* No default value */
		"rssi"
		},
};
...
asn_TYPE_member_t asn_MBR_MeasResultGERAN_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_MeasResultGERAN_specs_1 = {

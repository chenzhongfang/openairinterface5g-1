 ...
 */
static int
memb_nRB_CQI_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_nCS_AN_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_n1PUCCH_AN_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_type_deltaPUCCH_Shift_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_nRB_CQI_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0,  98 }	/* (0..98) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_nCS_AN_constr_7 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_n1PUCCH_AN_constr_8 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_deltaPUCCH_Shift_2 = {
	...
	{ 0, &asn_PER_type_deltaPUCCH_Shift_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PUCCH_ConfigCommon_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigCommon, nRB_CQI),
		...
		0,
		{ 0, &asn_PER_memb_nRB_CQI_constr_6,  memb_nRB_CQI_constraint_1 },
		0, 0, /* No default value */
		"nRB-CQI"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigCommon, nCS_AN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nCS_AN_constr_7,  memb_nCS_AN_constraint_1 },
		0, 0, /* No default value */
		"nCS-AN"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigCommon, n1PUCCH_AN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_n1PUCCH_AN_constr_8,  memb_n1PUCCH_AN_constraint_1 },
		0, 0, /* No default value */
		"n1PUCCH-AN"
		},
};

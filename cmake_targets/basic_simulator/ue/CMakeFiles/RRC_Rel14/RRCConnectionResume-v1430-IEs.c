...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_3 = {
	sizeof(struct RRCConnectionResume_v1430_IEs__nonCriticalExtension),
	offsetof(struct RRCConnectionResume_v1430_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_RRCConnectionResume_v1430_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RRCConnectionResume_v1430_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,

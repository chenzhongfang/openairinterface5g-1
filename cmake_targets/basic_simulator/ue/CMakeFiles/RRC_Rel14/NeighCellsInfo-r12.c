 ...
 */
static int
memb_p_b_r12_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_p_aList_r12_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static int
memb_transmissionModeList_r12_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
static int
memb_resAllocGranularity_r12_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_type_crs_PortsCount_r12_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_p_aList_r12_constr_10 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  3 }	/* (SIZE(1..3)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_p_b_r12_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_p_aList_r12_constr_10 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  3 }	/* (SIZE(1..3)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_transmissionModeList_r12_constr_12 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  8,  8 }	/* (SIZE(8..8)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_resAllocGranularity_r12_constr_13 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_crs_PortsCount_r12_4 = {
	...
	{ 0, &asn_PER_type_crs_PortsCount_r12_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_p_aList_r12_10 = {
	...
	{ 0, &asn_PER_type_p_aList_r12_constr_10, SEQUENCE_OF_constraint },
	asn_MBR_p_aList_r12_10,
	1,	/* Single element */
	&asn_SPC_p_aList_r12_specs_10	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_NeighCellsInfo_r12_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellsInfo_r12, p_b_r12),
		...
		0,
		{ 0, &asn_PER_memb_p_b_r12_constr_3,  memb_p_b_r12_constraint_1 },
		0, 0, /* No default value */
		"p-b-r12"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellsInfo_r12, p_aList_r12),
		...
		0,
		{ 0, &asn_PER_memb_p_aList_r12_constr_10,  memb_p_aList_r12_constraint_1 },
		0, 0, /* No default value */
		"p-aList-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellsInfo_r12, transmissionModeList_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_transmissionModeList_r12_constr_12,  memb_transmissionModeList_r12_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellsInfo_r12, resAllocGranularity_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_resAllocGranularity_r12_constr_13,  memb_resAllocGranularity_r12_constraint_1 },
		0, 0, /* No default value */
...
asn_SEQUENCE_specifics_t asn_SPC_NeighCellsInfo_r12_specs_1 = {

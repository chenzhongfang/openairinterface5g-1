 ...
 */
static int
memb_drx_Offset_r11_constraint_2(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_drx_CycleLength_r11_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_drx_ActiveTime_r11_constr_13 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_drx_Offset_r11_constr_12 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0,  255 }	/* (0..255) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_per_constraints_t asn_PER_type_TDM_AssistanceInfo_r11_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_drx_CycleLength_r11_value2enum_3[] = {
	{ 0,	4,	"sf40" },
	{ 1,	4,	"sf64" },
	{ 2,	4,	"sf80" },
	{ 3,	5,	"sf128" },
...
static const unsigned int asn_MAP_drx_CycleLength_r11_enum2value_3[] = {
	3,	/* sf128(3) */
	4,	/* sf160(4) */
	5,	/* sf256(5) */
	0,	/* sf40(0) */
...
static const asn_INTEGER_specifics_t asn_SPC_drx_CycleLength_r11_specs_3 = {
...
static const ber_tlv_tag_t asn_DEF_drx_CycleLength_r11_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_drx_CycleLength_r11_3 = {
	...
	{ 0, &asn_PER_type_drx_CycleLength_r11_constr_3, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_drx_CycleLength_r11_specs_3	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_drx_ActiveTime_r11_value2enum_13[] = {
	{ 0,	4,	"sf20" },
	{ 1,	4,	"sf30" },
	{ 2,	4,	"sf40" },
	{ 3,	4,	"sf60" },
...
static const unsigned int asn_MAP_drx_ActiveTime_r11_enum2value_13[] = {
	5,	/* sf100(5) */
	0,	/* sf20(0) */
	1,	/* sf30(1) */
	2,	/* sf40(2) */
...
static const asn_INTEGER_specifics_t asn_SPC_drx_ActiveTime_r11_specs_13 = {
...
static const ber_tlv_tag_t asn_DEF_drx_ActiveTime_r11_tags_13[] = {
...
asn_TYPE_descriptor_t asn_DEF_drx_ActiveTime_r11_13 = {
	...
	{ 0, &asn_PER_type_drx_ActiveTime_r11_constr_13, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_drx_AssistanceInfo_r11_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct TDM_AssistanceInfo_r11__drx_AssistanceInfo_r11, drx_Offset_r11),
		...
		0,
		{ 0, &asn_PER_memb_drx_Offset_r11_constr_12,  memb_drx_Offset_r11_constraint_2 },
		0, 0, /* No default value */
		"drx-Offset-r11"
		},
...
static const int asn_MAP_drx_AssistanceInfo_r11_oms_2[] = { 1 };
static const ber_tlv_tag_t asn_DEF_drx_AssistanceInfo_r11_tags_2[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_drx_AssistanceInfo_r11_tag2el_2[] = {
...
asn_TYPE_member_t asn_MBR_TDM_AssistanceInfo_r11_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_TDM_AssistanceInfo_r11_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* drx-AssistanceInfo-r11 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* idc-SubframePatternList-r11 */
};
asn_CHOICE_specifics_t asn_SPC_TDM_AssistanceInfo_r11_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_TDM_AssistanceInfo_r11 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_TDM_AssistanceInfo_r11_constr_1, CHOICE_constraint },

...
asn_TYPE_member_t asn_MBR_X2AP_UEContextRelease_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UEContextRelease, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_X2AP_ProtocolIE_Container_4989P5,
		0,
		{ 0, 0, 0 },
...
static const ber_tlv_tag_t asn_DEF_X2AP_UEContextRelease_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_X2AP_UEContextRelease_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* protocolIEs */
};
asn_SEQUENCE_specifics_t asn_SPC_X2AP_UEContextRelease_specs_1 = {

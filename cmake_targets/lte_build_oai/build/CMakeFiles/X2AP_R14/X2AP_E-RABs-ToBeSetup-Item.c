...
static asn_TYPE_member_t asn_MBR_X2AP_E_RABs_ToBeSetup_Item_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct X2AP_E_RABs_ToBeSetup_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_X2AP_ProtocolExtensionContainer_5040P1,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_X2AP_E_RABs_ToBeSetup_Item_oms_1[] = { 2, 4 };
static const ber_tlv_tag_t asn_DEF_X2AP_E_RABs_ToBeSetup_Item_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_X2AP_E_RABs_ToBeSetup_Item_tag2el_1[] = {

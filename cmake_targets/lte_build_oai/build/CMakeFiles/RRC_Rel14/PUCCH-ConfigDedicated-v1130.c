...
static int
memb_n1PUCCH_AN_CS_ListP1_r11_constraint_4(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static int
memb_nPUCCH_Identity_r11_constraint_9(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_n1PUCCH_AN_r11_constraint_9(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_type_n1PUCCH_AN_CS_ListP1_r11_constr_5 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  2,  4 }	/* (SIZE(2..4)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_n1PUCCH_AN_CS_ListP1_r11_constr_5 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  2,  4 }	/* (SIZE(2..4)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_n1PUCCH_AN_CS_v1130_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_nPUCCH_Identity_r11_constr_10 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 9,  9,  0,  503 }	/* (0..503) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_n1PUCCH_AN_r11_constr_11 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 11,  11,  0,  2047 }	/* (0..2047) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_nPUCCH_Param_r11_constr_7 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_n1PUCCH_AN_CS_ListP1_r11_tags_5[] = {
...
asn_TYPE_descriptor_t asn_DEF_n1PUCCH_AN_CS_ListP1_r11_5 = {
	...
	{ 0, &asn_PER_type_n1PUCCH_AN_CS_ListP1_r11_constr_5, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigDedicated_v1130__n1PUCCH_AN_CS_v1130__setup, n1PUCCH_AN_CS_ListP1_r11),
		...
		0,
		{ 0, &asn_PER_memb_n1PUCCH_AN_CS_ListP1_r11_constr_5,  memb_n1PUCCH_AN_CS_ListP1_r11_constraint_4 },
		0, 0, /* No default value */
		"n1PUCCH-AN-CS-ListP1-r11"
		},
};
...
static const asn_TYPE_tag2member_t asn_MAP_n1PUCCH_AN_CS_v1130_tag2el_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_n1PUCCH_AN_CS_v1130_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_n1PUCCH_AN_CS_v1130_constr_2, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_9[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigDedicated_v1130__nPUCCH_Param_r11__setup, nPUCCH_Identity_r11),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nPUCCH_Identity_r11_constr_10,  memb_nPUCCH_Identity_r11_constraint_9 },
		0, 0, /* No default value */
		"nPUCCH-Identity-r11"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigDedicated_v1130__nPUCCH_Param_r11__setup, n1PUCCH_AN_r11),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_n1PUCCH_AN_r11_constr_11,  memb_n1PUCCH_AN_r11_constraint_9 },
		0, 0, /* No default value */
		"n1PUCCH-AN-r11"
		},
};
...
static const asn_TYPE_tag2member_t asn_MAP_nPUCCH_Param_r11_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
...
asn_TYPE_descriptor_t asn_DEF_nPUCCH_Param_r11_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_nPUCCH_Param_r11_constr_7, CHOICE_constraint },
	asn_MBR_nPUCCH_Param_r11_7,
	2,	/* Elements count */
	&asn_SPC_nPUCCH_Param_r11_specs_7	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_PUCCH_ConfigDedicated_v1130_1[] = {
...
static const int asn_MAP_PUCCH_ConfigDedicated_v1130_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_PUCCH_ConfigDedicated_v1130_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PUCCH_ConfigDedicated_v1130_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* n1PUCCH-AN-CS-v1130 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nPUCCH-Param-r11 */
};
asn_SEQUENCE_specifics_t asn_SPC_PUCCH_ConfigDedicated_v1130_specs_1 = {

...
static int
memb_resourceConfigList_r11_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_resourceConfigList_r11_constr_3 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_CSI_RS_ConfigZP_r11_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ConfigZP_r11, resourceConfigList_r11),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_resourceConfigList_r11_constr_3,  memb_resourceConfigList_r11_constraint_1 },
		0, 0, /* No default value */
...
static const ber_tlv_tag_t asn_DEF_CSI_RS_ConfigZP_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CSI_RS_ConfigZP_r11_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_CSI_RS_ConfigZP_r11_specs_1 = {

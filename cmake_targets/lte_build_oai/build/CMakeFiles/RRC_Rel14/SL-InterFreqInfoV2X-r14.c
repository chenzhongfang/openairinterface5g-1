...
asn_TYPE_member_t asn_MBR_SL_InterFreqInfoV2X_r14_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct SL_InterFreqInfoV2X_r14, sl_MaxTxPower_r14),
	...
	{ ATF_POINTER, 4, offsetof(struct SL_InterFreqInfoV2X_r14, sl_Bandwidth_r14),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct SL_InterFreqInfoV2X_r14, v2x_SchedulingPool_r14),
	...
	{ ATF_POINTER, 2, offsetof(struct SL_InterFreqInfoV2X_r14, v2x_UE_ConfigList_r14),
	...
	{ ATF_POINTER, 1, offsetof(struct SL_InterFreqInfoV2X_r14, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_15,
		0,
...
static const int asn_MAP_SL_InterFreqInfoV2X_r14_oms_1[] = { 0, 2, 3, 4, 5, 6 };

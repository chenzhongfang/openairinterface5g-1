...
asn_TYPE_descriptor_t asn_DEF_bandParameterList_v1430_2 = {
	...
	{ 0, &asn_PER_type_bandParameterList_v1430_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_BandCombinationParameters_v1430_1[] = {
	{ ATF_POINTER, 3, offsetof(struct BandCombinationParameters_v1430, bandParameterList_v1430),
		...
		0,
		{ 0, &asn_PER_memb_bandParameterList_v1430_constr_2,  memb_bandParameterList_v1430_constraint_1 },
		0, 0, /* No default value */
		"bandParameterList-v1430"
		},
	{ ATF_POINTER, 2, offsetof(struct BandCombinationParameters_v1430, v2x_SupportedTxBandCombListPerBC_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_v2x_SupportedTxBandCombListPerBC_r14_constr_4,  memb_v2x_SupportedTxBandCombListPerBC_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct BandCombinationParameters_v1430, v2x_SupportedRxBandCombListPerBC_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_v2x_SupportedRxBandCombListPerBC_r14_constr_5,  memb_v2x_SupportedRxBandCombListPerBC_r14_constraint_1 },
		0, 0, /* No default value */

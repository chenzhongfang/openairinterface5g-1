...
static int
memb_tpc_RNTI_constraint_3(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_tpc_RNTI_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  16,  16 }	/* (SIZE(16..16)) */,
	0, 0	/* No PER value map */
};
asn_per_constraints_t asn_PER_type_TPC_PDCCH_Config_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TPC_PDCCH_Config__setup, tpc_RNTI),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_tpc_RNTI_constr_4,  memb_tpc_RNTI_constraint_3 },
...
asn_TYPE_member_t asn_MBR_TPC_PDCCH_Config_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_TPC_PDCCH_Config_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_TPC_PDCCH_Config = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_TPC_PDCCH_Config_constr_1, CHOICE_constraint },

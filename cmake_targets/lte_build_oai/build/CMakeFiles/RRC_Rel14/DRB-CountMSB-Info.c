...
asn_TYPE_member_t asn_MBR_DRB_CountMSB_Info_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DRB_CountMSB_Info, countMSB_Uplink),
		...
		0,
		{ 0, &asn_PER_memb_countMSB_Uplink_constr_3,  memb_countMSB_Uplink_constraint_1 },
		0, 0, /* No default value */
		"countMSB-Uplink"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DRB_CountMSB_Info, countMSB_Downlink),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_countMSB_Downlink_constr_4,  memb_countMSB_Downlink_constraint_1 },
		0, 0, /* No default value */
		"countMSB-Downlink"
		},
};

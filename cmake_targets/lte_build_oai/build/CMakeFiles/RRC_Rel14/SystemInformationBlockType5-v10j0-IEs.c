...
static int
memb_interFreqCarrierFreqList_v10j0_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_interFreqCarrierFreqList_v10j0_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_interFreqCarrierFreqList_v10j0_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_interFreqCarrierFreqList_v10j0_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_interFreqCarrierFreqList_v10j0_2 = {
	...
	{ 0, &asn_PER_type_interFreqCarrierFreqList_v10j0_constr_2, SEQUENCE_OF_constraint },
	asn_MBR_interFreqCarrierFreqList_v10j0_2,
	1,	/* Single element */
	&asn_SPC_interFreqCarrierFreqList_v10j0_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_SystemInformationBlockType5_v10j0_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType5_v10j0_IEs, interFreqCarrierFreqList_v10j0),
		...
		0,
		{ 0, &asn_PER_memb_interFreqCarrierFreqList_v10j0_constr_2,  memb_interFreqCarrierFreqList_v10j0_constraint_1 },
		0, 0, /* No default value */
		"interFreqCarrierFreqList-v10j0"
		},
...
static const int asn_MAP_SystemInformationBlockType5_v10j0_IEs_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_SystemInformationBlockType5_v10j0_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType5_v10j0_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* interFreqCarrierFreqList-v10j0 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension */
};
asn_SEQUENCE_specifics_t asn_SPC_SystemInformationBlockType5_v10j0_IEs_specs_1 = {

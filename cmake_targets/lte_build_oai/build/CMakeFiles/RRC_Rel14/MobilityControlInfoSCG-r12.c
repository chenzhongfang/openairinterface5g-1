...
static asn_per_constraints_t asn_PER_type_makeBeforeBreakSCG_r14_constr_16 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_makeBeforeBreakSCG_r14_value2enum_16[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_makeBeforeBreakSCG_r14_enum2value_16[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_makeBeforeBreakSCG_r14_specs_16 = {
	asn_MAP_makeBeforeBreakSCG_r14_value2enum_16,	/* "tag" => N; sorted by tag */
	asn_MAP_makeBeforeBreakSCG_r14_enum2value_16,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_makeBeforeBreakSCG_r14_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_makeBeforeBreakSCG_r14_16 = {
	"makeBeforeBreakSCG-r14",
	"makeBeforeBreakSCG-r14",
	&asn_OP_NativeEnumerated,
	asn_DEF_makeBeforeBreakSCG_r14_tags_16,
	sizeof(asn_DEF_makeBeforeBreakSCG_r14_tags_16)
		/sizeof(asn_DEF_makeBeforeBreakSCG_r14_tags_16[0]) - 1, /* 1 */
	asn_DEF_makeBeforeBreakSCG_r14_tags_16,	/* Same as above */
	sizeof(asn_DEF_makeBeforeBreakSCG_r14_tags_16)
		/sizeof(asn_DEF_makeBeforeBreakSCG_r14_tags_16[0]), /* 2 */
	{ 0, &asn_PER_type_makeBeforeBreakSCG_r14_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_makeBeforeBreakSCG_r14_specs_16	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_15[] = {
	{ ATF_POINTER, 2, offsetof(struct MobilityControlInfoSCG_r12__ext1, makeBeforeBreakSCG_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_makeBeforeBreakSCG_r14_16,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"makeBeforeBreakSCG-r14"
		},
	{ ATF_POINTER, 1, offsetof(struct MobilityControlInfoSCG_r12__ext1, rach_SkipSCG_r14),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_15 = {
	sizeof(struct MobilityControlInfoSCG_r12__ext1),
	offsetof(struct MobilityControlInfoSCG_r12__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_MobilityControlInfoSCG_r12_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct MobilityControlInfoSCG_r12, ue_IdentitySCG_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_C_RNTI,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct MobilityControlInfoSCG_r12, rach_ConfigDedicated_r12),
	...
	{ ATF_POINTER, 2, offsetof(struct MobilityControlInfoSCG_r12, cipheringAlgorithmSCG_r12),
	...
	{ ATF_POINTER, 1, offsetof(struct MobilityControlInfoSCG_r12, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_15,
		0,
...
static const int asn_MAP_MobilityControlInfoSCG_r12_oms_1[] = { 1, 2, 3, 4 };

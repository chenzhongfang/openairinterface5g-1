...
static int
memb_oneFrame_v1430_constraint_2(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_fourFrames_v1430_constraint_2(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_oneFrame_v1430_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  2,  2 }	/* (SIZE(2..2)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_fourFrames_v1430_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  8,  8 }	/* (SIZE(8..8)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_subframeAllocation_v1430_constr_2 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_subframeAllocation_v1430_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MBSFN_SubframeConfig_v1430__subframeAllocation_v1430, choice.oneFrame_v1430),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_oneFrame_v1430_constr_3,  memb_oneFrame_v1430_constraint_2 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MBSFN_SubframeConfig_v1430__subframeAllocation_v1430, choice.fourFrames_v1430),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_fourFrames_v1430_constr_4,  memb_fourFrames_v1430_constraint_2 },
		0, 0, /* No default value */
		"fourFrames-v1430"
		},
};
static const asn_TYPE_tag2member_t asn_MAP_subframeAllocation_v1430_tag2el_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_subframeAllocation_v1430_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_subframeAllocation_v1430_constr_2, CHOICE_constraint },
	asn_MBR_subframeAllocation_v1430_2,
	2,	/* Elements count */
	&asn_SPC_subframeAllocation_v1430_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_MBSFN_SubframeConfig_v1430_1[] = {
...
static const ber_tlv_tag_t asn_DEF_MBSFN_SubframeConfig_v1430_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MBSFN_SubframeConfig_v1430_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* subframeAllocation-v1430 */
};
asn_SEQUENCE_specifics_t asn_SPC_MBSFN_SubframeConfig_v1430_specs_1 = {

...
static asn_per_constraints_t asn_PER_type_c2_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_messageClassExtension_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_per_constraints_t asn_PER_type_SC_MCCH_MessageType_r13_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_c2_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_c2_constr_5, CHOICE_constraint },
	asn_MBR_c2_5,
	2,	/* Elements count */
	&asn_SPC_c2_specs_5	/* Additional specs */
};

static const ber_tlv_tag_t asn_DEF_messageClassExtensionFuture_r14_tags_8[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
static const asn_TYPE_tag2member_t asn_MAP_messageClassExtension_tag2el_4[] = {
...
asn_TYPE_descriptor_t asn_DEF_messageClassExtension_4 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_messageClassExtension_constr_4, CHOICE_constraint },
	asn_MBR_messageClassExtension_4,
	2,	/* Elements count */
	&asn_SPC_messageClassExtension_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_SC_MCCH_MessageType_r13_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_SC_MCCH_MessageType_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* c1 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* messageClassExtension */
};
asn_CHOICE_specifics_t asn_SPC_SC_MCCH_MessageType_r13_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SC_MCCH_MessageType_r13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_SC_MCCH_MessageType_r13_constr_1, CHOICE_constraint },

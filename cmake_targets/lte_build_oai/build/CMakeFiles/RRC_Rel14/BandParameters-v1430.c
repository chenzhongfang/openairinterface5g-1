...
static int
memb_retuningTimeInfoBandList_r14_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static asn_per_constraints_t asn_PER_type_retuningTimeInfoBandList_r14_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_per_constraints_t asn_PER_memb_retuningTimeInfoBandList_r14_constr_7 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_ul_256QAM_r14_3 = {
	...
	{ 0, &asn_PER_type_ul_256QAM_r14_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ul_256QAM_perCC_InfoList_r14_5 = {
	...
	{ 0, &asn_PER_type_ul_256QAM_perCC_InfoList_r14_constr_5, SEQUENCE_OF_constraint },
	asn_MBR_ul_256QAM_perCC_InfoList_r14_5,
	1,	/* Single element */
	&asn_SPC_ul_256QAM_perCC_InfoList_r14_specs_5	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_retuningTimeInfoBandList_r14_7[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RetuningTimeInfo_r14,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		""
...
static const ber_tlv_tag_t asn_DEF_retuningTimeInfoBandList_r14_tags_7[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_retuningTimeInfoBandList_r14_specs_7 = {
	sizeof(struct BandParameters_v1430__retuningTimeInfoBandList_r14),
	offsetof(struct BandParameters_v1430__retuningTimeInfoBandList_r14, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_retuningTimeInfoBandList_r14_7 = {
	"retuningTimeInfoBandList-r14",
	"retuningTimeInfoBandList-r14",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_retuningTimeInfoBandList_r14_tags_7,
	sizeof(asn_DEF_retuningTimeInfoBandList_r14_tags_7)
		/sizeof(asn_DEF_retuningTimeInfoBandList_r14_tags_7[0]) - 1, /* 1 */
	asn_DEF_retuningTimeInfoBandList_r14_tags_7,	/* Same as above */
	sizeof(asn_DEF_retuningTimeInfoBandList_r14_tags_7)
		/sizeof(asn_DEF_retuningTimeInfoBandList_r14_tags_7[0]), /* 2 */
	{ 0, &asn_PER_type_retuningTimeInfoBandList_r14_constr_7, SEQUENCE_OF_constraint },
	asn_MBR_retuningTimeInfoBandList_r14_7,
	1,	/* Single element */
	&asn_SPC_retuningTimeInfoBandList_r14_specs_7	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_BandParameters_v1430_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct BandParameters_v1430, ul_256QAM_perCC_InfoList_r14),
		...
		0,
		{ 0, &asn_PER_memb_ul_256QAM_perCC_InfoList_r14_constr_5,  memb_ul_256QAM_perCC_InfoList_r14_constraint_1 },
		0, 0, /* No default value */
		"ul-256QAM-perCC-InfoList-r14"
		},
	{ ATF_POINTER, 1, offsetof(struct BandParameters_v1430, retuningTimeInfoBandList_r14),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_retuningTimeInfoBandList_r14_7,
		0,
		{ 0, &asn_PER_memb_retuningTimeInfoBandList_r14_constr_7,  memb_retuningTimeInfoBandList_r14_constraint_1 },
		0, 0, /* No default value */
		"retuningTimeInfoBandList-r14"
		},
};
...
static const asn_TYPE_tag2member_t asn_MAP_BandParameters_v1430_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* retuningTimeInfoBandList-r14 */
};

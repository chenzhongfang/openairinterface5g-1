...
static asn_TYPE_member_t asn_MBR_ext3_13[] = {
	{ ATF_POINTER, 1, offsetof(struct PSCellToAddMod_r12__ext3, radioResourceConfigDedicatedPSCell_v1370),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_13 = {
	sizeof(struct PSCellToAddMod_r12__ext3),
	offsetof(struct PSCellToAddMod_r12__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PSCellToAddMod_r12_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct PSCellToAddMod_r12, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct PSCellToAddMod_r12, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct PSCellToAddMod_r12, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_13,
		0,

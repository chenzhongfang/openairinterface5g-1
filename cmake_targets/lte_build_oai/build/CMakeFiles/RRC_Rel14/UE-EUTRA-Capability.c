...
static int
memb_ue_Category_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_featureGroupIndicators_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
static asn_per_constraints_t asn_PER_memb_ue_Category_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  1,  5 }	/* (1..5) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_featureGroupIndicators_constr_8 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_TYPE_member_t asn_MBR_UE_EUTRA_Capability_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UE_EUTRA_Capability, ue_Category),
		...
		0,
		{ 0, &asn_PER_memb_ue_Category_constr_3,  memb_ue_Category_constraint_1 },
		0, 0, /* No default value */
		"ue-Category"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct UE_EUTRA_Capability, featureGroupIndicators),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_featureGroupIndicators_constr_8,  memb_featureGroupIndicators_constraint_1 },
		0, 0, /* No default value */

...
static asn_per_constraints_t asn_PER_type_syncTxPeriodic_r13_constr_16 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_gnss_Sync_r14_constr_20 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_txParameters_r12_5[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfig_r12__txParameters_r12, syncInfoReserved_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_syncInfoReserved_r12_constr_8,  memb_syncInfoReserved_r12_constraint_5 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_discSyncWindow_r12_11 = {
	...
	{ 0, &asn_PER_type_discSyncWindow_r12_constr_11, NativeEnumerated_constraint },
...
static const asn_INTEGER_enum_map_t asn_MAP_syncTxPeriodic_r13_value2enum_16[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_syncTxPeriodic_r13_enum2value_16[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_syncTxPeriodic_r13_specs_16 = {
...
static const ber_tlv_tag_t asn_DEF_syncTxPeriodic_r13_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_syncTxPeriodic_r13_16 = {
	...
	{ 0, &asn_PER_type_syncTxPeriodic_r13_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static const asn_INTEGER_enum_map_t asn_MAP_gnss_Sync_r14_value2enum_20[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_gnss_Sync_r14_enum2value_20[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_gnss_Sync_r14_specs_20 = {
	asn_MAP_gnss_Sync_r14_value2enum_20,	/* "tag" => N; sorted by tag */
	asn_MAP_gnss_Sync_r14_enum2value_20,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_gnss_Sync_r14_tags_20[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_gnss_Sync_r14_20 = {
	"gnss-Sync-r14",
	"gnss-Sync-r14",
	&asn_OP_NativeEnumerated,
	asn_DEF_gnss_Sync_r14_tags_20,
	sizeof(asn_DEF_gnss_Sync_r14_tags_20)
		/sizeof(asn_DEF_gnss_Sync_r14_tags_20[0]) - 1, /* 1 */
	asn_DEF_gnss_Sync_r14_tags_20,	/* Same as above */
	sizeof(asn_DEF_gnss_Sync_r14_tags_20)
		/sizeof(asn_DEF_gnss_Sync_r14_tags_20[0]), /* 2 */
	{ 0, &asn_PER_type_gnss_Sync_r14_constr_20, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_gnss_Sync_r14_specs_20	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_18[] = {
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfig_r12__ext2, syncOffsetIndicator_v1430),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfig_r12__ext2, gnss_Sync_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_gnss_Sync_r14_20,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"gnss-Sync-r14"
...
static asn_TYPE_member_t asn_MBR_ext3_22[] = {
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfig_r12__ext3, syncOffsetIndicator2_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfig_r12__ext3, syncOffsetIndicator3_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SL_OffsetIndicatorSync_r14,
		0,
...
static const int asn_MAP_ext3_oms_22[] = { 0, 1 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_22 = {
	sizeof(struct SL_SyncConfig_r12__ext3),
	offsetof(struct SL_SyncConfig_r12__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SL_SyncConfig_r12_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct SL_SyncConfig_r12, txParameters_r12),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct SL_SyncConfig_r12, rxParamsNCell_r12),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct SL_SyncConfig_r12, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_15,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfig_r12, ext2),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext2_18,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfig_r12, ext3),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext3_22,
		0,
...
static const int asn_MAP_SL_SyncConfig_r12_oms_1[] = { 3, 4, 5, 6, 7 };

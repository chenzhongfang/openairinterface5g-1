...
asn_per_constraints_t asn_PER_type_BCCH_DL_SCH_MessageType_NB_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_member_t asn_MBR_BCCH_DL_SCH_MessageType_NB_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_BCCH_DL_SCH_MessageType_NB_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* c1 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* messageClassExtension */
};
asn_CHOICE_specifics_t asn_SPC_BCCH_DL_SCH_MessageType_NB_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_BCCH_DL_SCH_MessageType_NB = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_BCCH_DL_SCH_MessageType_NB_constr_1, CHOICE_constraint },

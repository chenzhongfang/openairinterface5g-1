...
asn_TYPE_descriptor_t asn_DEF_t_Evaluation_2 = {
	...
	{ 0, &asn_PER_type_t_Evaluation_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_t_HystNormal_11 = {
	...
	{ 0, &asn_PER_type_t_HystNormal_constr_11, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_MobilityStateParameters_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MobilityStateParameters, n_CellChangeMedium),
		...
		0,
		{ 0, &asn_PER_memb_n_CellChangeMedium_constr_20,  memb_n_CellChangeMedium_constraint_1 },
		0, 0, /* No default value */
		"n-CellChangeMedium"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MobilityStateParameters, n_CellChangeHigh),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_n_CellChangeHigh_constr_21,  memb_n_CellChangeHigh_constraint_1 },
		0, 0, /* No default value */
		"n-CellChangeHigh"
		},
};

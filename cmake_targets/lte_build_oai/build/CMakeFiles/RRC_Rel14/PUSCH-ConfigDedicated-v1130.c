...
static int
memb_nPUSCH_Identity_r11_constraint_4(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_nDMRS_CSH_Identity_r11_constraint_4(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_nPUSCH_Identity_r11_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 9,  9,  0,  509 }	/* (0..509) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_nDMRS_CSH_Identity_r11_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 9,  9,  0,  509 }	/* (0..509) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_pusch_DMRS_r11_constr_2 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_setup_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigDedicated_v1130__pusch_DMRS_r11__setup, nPUSCH_Identity_r11),
		...
		0,
		{ 0, &asn_PER_memb_nPUSCH_Identity_r11_constr_5,  memb_nPUSCH_Identity_r11_constraint_4 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigDedicated_v1130__pusch_DMRS_r11__setup, nDMRS_CSH_Identity_r11),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_nDMRS_CSH_Identity_r11_constr_6,  memb_nDMRS_CSH_Identity_r11_constraint_4 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_pusch_DMRS_r11_tag2el_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_pusch_DMRS_r11_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_pusch_DMRS_r11_constr_2, CHOICE_constraint },
	asn_MBR_pusch_DMRS_r11_2,
	2,	/* Elements count */
	&asn_SPC_pusch_DMRS_r11_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_PUSCH_ConfigDedicated_v1130_1[] = {
...
static const ber_tlv_tag_t asn_DEF_PUSCH_ConfigDedicated_v1130_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PUSCH_ConfigDedicated_v1130_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* pusch-DMRS-r11 */
};
asn_SEQUENCE_specifics_t asn_SPC_PUSCH_ConfigDedicated_v1130_specs_1 = {

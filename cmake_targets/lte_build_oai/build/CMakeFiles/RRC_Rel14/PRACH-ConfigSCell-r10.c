...
static int
memb_prach_ConfigIndex_r10_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_prach_ConfigIndex_r10_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  63 }	/* (0..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_PRACH_ConfigSCell_r10_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_ConfigSCell_r10, prach_ConfigIndex_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_prach_ConfigIndex_r10_constr_2,  memb_prach_ConfigIndex_r10_constraint_1 },
...
asn_SEQUENCE_specifics_t asn_SPC_PRACH_ConfigSCell_r10_specs_1 = {

...
asn_TYPE_member_t asn_MBR_RF_Parameters_v10i0_1[] = {
...
static const int asn_MAP_RF_Parameters_v10i0_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_RF_Parameters_v10i0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RF_Parameters_v10i0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* supportedBandCombination-v10i0 */
};
asn_SEQUENCE_specifics_t asn_SPC_RF_Parameters_v10i0_specs_1 = {

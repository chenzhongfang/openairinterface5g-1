...
static asn_SEQUENCE_specifics_t asn_SPC_criticalExtensionsFuture_specs_4 = {
	sizeof(struct RRCConnectionRequest_NB__criticalExtensions__criticalExtensionsFuture),
	offsetof(struct RRCConnectionRequest_NB__criticalExtensions__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionRequest_NB__criticalExtensions, choice.rrcConnectionRequest_r13),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionRequest_NB__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_criticalExtensions_specs_2 = {
	...
	offsetof(struct RRCConnectionRequest_NB__criticalExtensions, _asn_ctx),
	offsetof(struct RRCConnectionRequest_NB__criticalExtensions, present),
	sizeof(((struct RRCConnectionRequest_NB__criticalExtensions *)0)->present),
...
asn_TYPE_member_t asn_MBR_RRCConnectionRequest_NB_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionRequest_NB, criticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static const ber_tlv_tag_t asn_DEF_RRCConnectionRequest_NB_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RRCConnectionRequest_NB_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* criticalExtensions */
};
asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionRequest_NB_specs_1 = {
	sizeof(struct RRCConnectionRequest_NB),
	offsetof(struct RRCConnectionRequest_NB, _asn_ctx),
	asn_MAP_RRCConnectionRequest_NB_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_RRCConnectionRequest_NB = {
	"RRCConnectionRequest-NB",
	"RRCConnectionRequest-NB",
	&asn_OP_SEQUENCE,
	asn_DEF_RRCConnectionRequest_NB_tags_1,
	sizeof(asn_DEF_RRCConnectionRequest_NB_tags_1)
		/sizeof(asn_DEF_RRCConnectionRequest_NB_tags_1[0]), /* 1 */
	asn_DEF_RRCConnectionRequest_NB_tags_1,	/* Same as above */
	sizeof(asn_DEF_RRCConnectionRequest_NB_tags_1)
		/sizeof(asn_DEF_RRCConnectionRequest_NB_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_RRCConnectionRequest_NB_1,
	1,	/* Elements count */
	&asn_SPC_RRCConnectionRequest_NB_specs_1	/* Additional specs */
};

...
static asn_per_constraints_t asn_PER_type_command_constr_2 CC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_steerToWLAN_r13_tags_3[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_steerToWLAN_r13_tag2el_3[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_command_tag2el_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_command_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_command_constr_2, CHOICE_constraint },
	asn_MBR_command_2,
	2,	/* Elements count */
	&asn_SPC_command_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_RCLWI_Config_r13_1[] = {
...
static const ber_tlv_tag_t asn_DEF_RCLWI_Config_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RCLWI_Config_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* command */
};
asn_SEQUENCE_specifics_t asn_SPC_RCLWI_Config_r13_specs_1 = {

...
asn_TYPE_member_t asn_MBR_MeasResultForECID_r9_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultForECID_r9, ue_RxTxTimeDiffResult_r9),
		...
		0,
		{ 0, &asn_PER_memb_ue_RxTxTimeDiffResult_r9_constr_2,  memb_ue_RxTxTimeDiffResult_r9_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultForECID_r9, currentSFN_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_currentSFN_r9_constr_3,  memb_currentSFN_r9_constraint_1 },
		0, 0, /* No default value */
		"currentSFN-r9"
		},
};

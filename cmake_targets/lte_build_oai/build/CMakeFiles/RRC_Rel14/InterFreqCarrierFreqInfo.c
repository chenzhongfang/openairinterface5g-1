...
static asn_TYPE_member_t asn_MBR_threshX_Q_r9_19[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct InterFreqCarrierFreqInfo__ext1__threshX_Q_r9, threshX_HighQ_r9),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InterFreqCarrierFreqInfo__ext1__threshX_Q_r9, threshX_LowQ_r9),
...
static const ber_tlv_tag_t asn_DEF_threshX_Q_r9_tags_19[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_threshX_Q_r9_tag2el_19[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* threshX-HighQ-r9 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* threshX-LowQ-r9 */
};
static asn_SEQUENCE_specifics_t asn_SPC_threshX_Q_r9_specs_19 = {
	sizeof(struct InterFreqCarrierFreqInfo__ext1__threshX_Q_r9),
	offsetof(struct InterFreqCarrierFreqInfo__ext1__threshX_Q_r9, _asn_ctx),
	asn_MAP_threshX_Q_r9_tag2el_19,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_threshX_Q_r9_19 = {
	"threshX-Q-r9",
	"threshX-Q-r9",
	&asn_OP_SEQUENCE,
	asn_DEF_threshX_Q_r9_tags_19,
	sizeof(asn_DEF_threshX_Q_r9_tags_19)
		/sizeof(asn_DEF_threshX_Q_r9_tags_19[0]) - 1, /* 1 */
	asn_DEF_threshX_Q_r9_tags_19,	/* Same as above */
	sizeof(asn_DEF_threshX_Q_r9_tags_19)
		/sizeof(asn_DEF_threshX_Q_r9_tags_19[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_threshX_Q_r9_19,
	2,	/* Elements count */
	&asn_SPC_threshX_Q_r9_specs_19	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_17[] = {
	{ ATF_POINTER, 2, offsetof(struct InterFreqCarrierFreqInfo__ext1, q_QualMin_r9),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct InterFreqCarrierFreqInfo__ext1, threshX_Q_r9),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_threshX_Q_r9_19,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"threshX-Q-r9"
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_17 = {
	sizeof(struct InterFreqCarrierFreqInfo__ext1),
	offsetof(struct InterFreqCarrierFreqInfo__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_22[] = {
	{ ATF_POINTER, 1, offsetof(struct InterFreqCarrierFreqInfo__ext2, q_QualMinWB_r11),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Q_QualMin_r9,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_22 = {
	sizeof(struct InterFreqCarrierFreqInfo__ext2),
	offsetof(struct InterFreqCarrierFreqInfo__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_InterFreqCarrierFreqInfo_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct InterFreqCarrierFreqInfo, ext1),
		(ASN_TAG_CLASS_CONTEXT | (14 << 2)),
		0,
		&asn_DEF_ext1_17,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct InterFreqCarrierFreqInfo, ext2),
		(ASN_TAG_CLASS_CONTEXT | (15 << 2)),
		0,
		&asn_DEF_ext2_22,
		0,

...
asn_TYPE_member_t asn_MBR_LWIP_Config_r13_1[] = {
...
static const int asn_MAP_LWIP_Config_r13_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_LWIP_Config_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_LWIP_Config_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* lwip-MobilityConfig-r13 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tunnelConfigLWIP-r13 */
};
asn_SEQUENCE_specifics_t asn_SPC_LWIP_Config_r13_specs_1 = {

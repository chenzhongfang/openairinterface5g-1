...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon_NB_r13__ext1, powerRampingParameters_v1450),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_7 = {
	sizeof(struct RACH_ConfigCommon_NB_r13__ext1),
	offsetof(struct RACH_ConfigCommon_NB_r13__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RACH_ConfigCommon_NB_r13_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RACH_ConfigCommon_NB_r13, connEstFailOffset_r13),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_connEstFailOffset_r13_constr_5,  memb_connEstFailOffset_r13_constraint_1 },
		0, 0, /* No default value */
		"connEstFailOffset-r13"
		},
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
...
static const int asn_MAP_RACH_ConfigCommon_NB_r13_oms_1[] = { 3, 4 };

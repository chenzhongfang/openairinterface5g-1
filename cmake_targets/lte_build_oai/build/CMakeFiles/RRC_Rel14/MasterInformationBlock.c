...
asn_TYPE_descriptor_t asn_DEF_dl_Bandwidth_2 = {
	...
	{ 0, &asn_PER_type_dl_Bandwidth_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_MasterInformationBlock_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock, systemFrameNumber),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_systemFrameNumber_constr_10,  memb_systemFrameNumber_constraint_1 },
		0, 0, /* No default value */
		"systemFrameNumber"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock, spare),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_spare_constr_12,  memb_spare_constraint_1 },
		0, 0, /* No default value */
		"spare"
		},
};

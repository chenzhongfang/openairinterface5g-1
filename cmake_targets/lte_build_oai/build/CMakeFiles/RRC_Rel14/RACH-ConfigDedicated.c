...
static int
memb_ra_PRACH_MaskIndex_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_ra_PreambleIndex_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  63 }	/* (0..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_ra_PRACH_MaskIndex_constr_3 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_RACH_ConfigDedicated_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RACH_ConfigDedicated, ra_PreambleIndex),
		...
		0,
		{ 0, &asn_PER_memb_ra_PreambleIndex_constr_2,  memb_ra_PreambleIndex_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RACH_ConfigDedicated, ra_PRACH_MaskIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ra_PRACH_MaskIndex_constr_3,  memb_ra_PRACH_MaskIndex_constraint_1 },
		0, 0, /* No default value */
		"ra-PRACH-MaskIndex"
		},
};

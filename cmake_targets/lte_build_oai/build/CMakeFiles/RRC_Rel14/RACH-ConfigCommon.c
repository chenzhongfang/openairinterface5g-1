...
asn_TYPE_descriptor_t asn_DEF_ra_ResponseWindowSize_55 = {
	...
	{ 0, &asn_PER_type_ra_ResponseWindowSize_constr_55, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_mac_ContentionResolutionTimer_64 = {
	...
	{ 0, &asn_PER_type_mac_ContentionResolutionTimer_constr_64, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_ext1_75[] = {
	{ ATF_POINTER, 2, offsetof(struct RACH_ConfigCommon__ext1, preambleTransMax_CE_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PreambleTransMax,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon__ext1, rach_CE_LevelInfoList_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext1_oms_75[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_ext1_tags_75[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_75[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_75 = {
	...
	offsetof(struct RACH_ConfigCommon__ext1, _asn_ctx),
	asn_MAP_ext1_tag2el_75,
	2,	/* Count of tags in the map */
	asn_MAP_ext1_oms_75,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext1_75 = {
	"ext1",
	"ext1",
	&asn_OP_SEQUENCE,
	asn_DEF_ext1_tags_75,
	sizeof(asn_DEF_ext1_tags_75)
		/sizeof(asn_DEF_ext1_tags_75[0]) - 1, /* 1 */
	asn_DEF_ext1_tags_75,	/* Same as above */
	sizeof(asn_DEF_ext1_tags_75)
		/sizeof(asn_DEF_ext1_tags_75[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_ext1_75,
	2,	/* Elements count */
	&asn_SPC_ext1_specs_75	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_RACH_ConfigCommon_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RACH_ConfigCommon, maxHARQ_Msg3Tx),
		...
		0,
		{ 0, &asn_PER_memb_maxHARQ_Msg3Tx_constr_73,  memb_maxHARQ_Msg3Tx_constraint_1 },
		0, 0, /* No default value */
		"maxHARQ-Msg3Tx"
		},
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_75,
		0,
...
static const int asn_MAP_RACH_ConfigCommon_oms_1[] = { 4 };

...
static asn_per_constraints_t asn_PER_type_mch_SchedulingPeriod_v1430_constr_18 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_mch_SchedulingPeriod_v1430_value2enum_18[] = {
	{ 0,	3,	"rf1" },
	{ 1,	3,	"rf2" }
};
static const unsigned int asn_MAP_mch_SchedulingPeriod_v1430_enum2value_18[] = {
	0,	/* rf1(0) */
	1	/* rf2(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_mch_SchedulingPeriod_v1430_specs_18 = {
...
static const ber_tlv_tag_t asn_DEF_mch_SchedulingPeriod_v1430_tags_18[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_mch_SchedulingPeriod_v1430_18 = {
	...
	{ 0, &asn_PER_type_mch_SchedulingPeriod_v1430_constr_18, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */

...
asn_per_constraints_t asn_PER_type_BandClassPriorityListHRPD_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_BandClassPriorityListHRPD_1[] = {
	{ ATF_POINTER, 0, 0,
...
asn_SET_OF_specifics_t asn_SPC_BandClassPriorityListHRPD_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_BandClassPriorityListHRPD = {
	...
	sizeof(asn_DEF_BandClassPriorityListHRPD_tags_1)
		/sizeof(asn_DEF_BandClassPriorityListHRPD_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_BandClassPriorityListHRPD_constr_1, SEQUENCE_OF_constraint },

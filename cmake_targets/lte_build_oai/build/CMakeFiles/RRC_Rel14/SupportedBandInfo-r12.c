 ...
 */
static asn_per_constraints_t asn_PER_type_support_r12_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_support_r12_value2enum_2[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_support_r12_enum2value_2[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_support_r12_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_support_r12_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_support_r12_2 = {
	...
	{ 0, &asn_PER_type_support_r12_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_support_r12_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_SupportedBandInfo_r12_1[] = {
...
static const int asn_MAP_SupportedBandInfo_r12_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_SupportedBandInfo_r12_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SupportedBandInfo_r12_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* support-r12 */
};
asn_SEQUENCE_specifics_t asn_SPC_SupportedBandInfo_r12_specs_1 = {

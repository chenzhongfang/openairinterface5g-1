...
static asn_TYPE_member_t asn_MBR_ext4_10[] = {
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedSCell_r10__ext4, physicalConfigDedicatedSCell_v1370),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext4_specs_10 = {
	sizeof(struct RadioResourceConfigDedicatedSCell_r10__ext4),
	offsetof(struct RadioResourceConfigDedicatedSCell_r10__ext4, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicatedSCell_r10_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct RadioResourceConfigDedicatedSCell_r10, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_4,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigDedicatedSCell_r10, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_6,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicatedSCell_r10, ext3),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext3_8,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedSCell_r10, ext4),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext4_10,
		0,

...
asn_TYPE_member_t asn_MBR_ThresholdUTRA_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ThresholdUTRA, choice.utra_RSCP),
		...
		0,
		{ 0, &asn_PER_memb_utra_RSCP_constr_2,  memb_utra_RSCP_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ThresholdUTRA, choice.utra_EcN0),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_utra_EcN0_constr_3,  memb_utra_EcN0_constraint_1 },
		0, 0, /* No default value */
		"utra-EcN0"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_ThresholdUTRA = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ThresholdUTRA_constr_1, CHOICE_constraint },

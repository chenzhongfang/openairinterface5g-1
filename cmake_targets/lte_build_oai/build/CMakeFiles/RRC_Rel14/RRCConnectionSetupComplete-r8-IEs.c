...
asn_TYPE_member_t asn_MBR_RRCConnectionSetupComplete_r8_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionSetupComplete_r8_IEs, selectedPLMN_Identity),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_selectedPLMN_Identity_constr_2,  memb_selectedPLMN_Identity_constraint_1 },
...
asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionSetupComplete_r8_IEs_specs_1 = {

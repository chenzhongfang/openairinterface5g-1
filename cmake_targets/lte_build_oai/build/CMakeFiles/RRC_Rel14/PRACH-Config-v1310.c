...
static int
memb_initial_CE_level_r13_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_initial_CE_level_r13_constr_24 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_PRACH_Config_v1310_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PRACH_Config_v1310, initial_CE_level_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_initial_CE_level_r13_constr_24,  memb_initial_CE_level_r13_constraint_1 },
		0, 0, /* No default value */
		"initial-CE-level-r13"
		},
};
static const int asn_MAP_PRACH_Config_v1310_oms_1[] = { 0, 1, 2, 3, 4 };
static const ber_tlv_tag_t asn_DEF_PRACH_Config_v1310_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PRACH_Config_v1310_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_PRACH_Config_v1310_specs_1 = {

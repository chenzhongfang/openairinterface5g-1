...
static int
memb_neighFreqInfoList_r11_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_neighFreqInfoList_r11_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_neighFreqInfoList_r11_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_neighFreqInfoList_r11_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_neighFreqInfoList_r11_3 = {
	...
	{ 0, &asn_PER_type_neighFreqInfoList_r11_constr_3, SEQUENCE_OF_constraint },
	asn_MBR_neighFreqInfoList_r11_3,
	1,	/* Single element */
	&asn_SPC_neighFreqInfoList_r11_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_NeighCellCDMA2000_r11_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellCDMA2000_r11, neighFreqInfoList_r11),
		...
		0,
		{ 0, &asn_PER_memb_neighFreqInfoList_r11_constr_3,  memb_neighFreqInfoList_r11_constraint_1 },
		0, 0, /* No default value */
		"neighFreqInfoList-r11"
		},
};
static const ber_tlv_tag_t asn_DEF_NeighCellCDMA2000_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NeighCellCDMA2000_r11_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* bandClass */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* neighFreqInfoList-r11 */
};
asn_SEQUENCE_specifics_t asn_SPC_NeighCellCDMA2000_r11_specs_1 = {

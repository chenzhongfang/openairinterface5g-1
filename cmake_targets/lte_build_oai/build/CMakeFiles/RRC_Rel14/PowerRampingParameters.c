 ...
 * so here we adjust the DEF accordingly.
 */
static asn_per_constraints_t asn_PER_type_powerRampingStep_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_preambleInitialReceivedTargetPower_constr_7 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  15 }	/* (0..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_powerRampingStep_value2enum_2[] = {
	{ 0,	3,	"dB0" },
	{ 1,	3,	"dB2" },
	{ 2,	3,	"dB4" },
	{ 3,	3,	"dB6" }
};
static const unsigned int asn_MAP_powerRampingStep_enum2value_2[] = {
	0,	/* dB0(0) */
	1,	/* dB2(1) */
	2,	/* dB4(2) */
	3	/* dB6(3) */
};
static const asn_INTEGER_specifics_t asn_SPC_powerRampingStep_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_powerRampingStep_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_powerRampingStep_2 = {
	...
	{ 0, &asn_PER_type_powerRampingStep_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_powerRampingStep_specs_2	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_preambleInitialReceivedTargetPower_value2enum_7[] = {
	{ 0,	7,	"dBm-120" },
	{ 1,	7,	"dBm-118" },
	{ 2,	7,	"dBm-116" },
	{ 3,	7,	"dBm-114" },
...
static const unsigned int asn_MAP_preambleInitialReceivedTargetPower_enum2value_7[] = {
	10,	/* dBm-100(10) */
	9,	/* dBm-102(9) */
	8,	/* dBm-104(8) */
	7,	/* dBm-106(7) */
...
static const asn_INTEGER_specifics_t asn_SPC_preambleInitialReceivedTargetPower_specs_7 = {
...
static const ber_tlv_tag_t asn_DEF_preambleInitialReceivedTargetPower_tags_7[] = {
...
asn_TYPE_descriptor_t asn_DEF_preambleInitialReceivedTargetPower_7 = {
	...
	{ 0, &asn_PER_type_preambleInitialReceivedTargetPower_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_preambleInitialReceivedTargetPower_specs_7	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_PowerRampingParameters_1[] = {
...
static const ber_tlv_tag_t asn_DEF_PowerRampingParameters_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PowerRampingParameters_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* powerRampingStep */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* preambleInitialReceivedTargetPower */
};
asn_SEQUENCE_specifics_t asn_SPC_PowerRampingParameters_specs_1 = {

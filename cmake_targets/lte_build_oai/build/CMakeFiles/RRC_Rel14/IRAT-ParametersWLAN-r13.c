...
static int
memb_supportedBandListWLAN_r13_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_supportedBandListWLAN_r13_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_supportedBandListWLAN_r13_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_supportedBandListWLAN_r13_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_supportedBandListWLAN_r13_2 = {
	...
	{ 0, &asn_PER_type_supportedBandListWLAN_r13_constr_2, SEQUENCE_OF_constraint },
	asn_MBR_supportedBandListWLAN_r13_2,
	1,	/* Single element */
	&asn_SPC_supportedBandListWLAN_r13_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_IRAT_ParametersWLAN_r13_1[] = {
	{ ATF_POINTER, 1, offsetof(struct IRAT_ParametersWLAN_r13, supportedBandListWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_supportedBandListWLAN_r13_2,
		0,
		{ 0, &asn_PER_memb_supportedBandListWLAN_r13_constr_2,  memb_supportedBandListWLAN_r13_constraint_1 },
		0, 0, /* No default value */
		"supportedBandListWLAN-r13"
		},
};
static const int asn_MAP_IRAT_ParametersWLAN_r13_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_IRAT_ParametersWLAN_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_IRAT_ParametersWLAN_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* supportedBandListWLAN-r13 */
};
asn_SEQUENCE_specifics_t asn_SPC_IRAT_ParametersWLAN_r13_specs_1 = {

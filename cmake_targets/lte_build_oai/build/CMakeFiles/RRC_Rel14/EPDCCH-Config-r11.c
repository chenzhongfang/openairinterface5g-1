...
asn_TYPE_descriptor_t asn_DEF_subframePatternConfig_r11_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_subframePatternConfig_r11_constr_5, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_4[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct EPDCCH_Config_r11__config_r11__setup, startSymbol_r11),
		...
		0,
		{ 0, &asn_PER_memb_startSymbol_r11_constr_9,  memb_startSymbol_r11_constraint_4 },
		0, 0, /* No default value */
		"startSymbol-r11"
		},
...
asn_TYPE_descriptor_t asn_DEF_config_r11_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_config_r11_constr_2, CHOICE_constraint },
